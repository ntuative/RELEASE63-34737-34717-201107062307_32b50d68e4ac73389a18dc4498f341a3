package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_2024:String = "float";
      ...
      private static const const_718:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_717:String = "value";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_718));
         }
         else
         {
            _loc4_ = param1.child(const_718)[0];
         }
         ...
         _loc7_ = param1.attribute(const_717);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_717));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_717)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_300 || _loc5_ == const_170)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_177:
               return uint(param1);
            case const_170:
               return param1.split(const_1425);
            default:
