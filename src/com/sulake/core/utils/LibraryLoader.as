package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2058:uint = 2;
      
      protected static const const_2057:uint = 4;
      
      protected static const const_2059:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_1953:int = 5;
      ...
      private static var var_1094:Array = new Array();
      
      private static var var_886:Array = new Array();
      ...
      protected var var_700:Class;
      
      protected var var_511:uint = 0;
      ...
      protected var var_1429:int;
      
      protected var var_1430:int;
      
      protected var var_3126:uint = 0;
      
      protected var var_3058:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1240)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_886[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_886.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_886.length < const_1770 && false)
            {
               _loc1_ = var_1094.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1152 ? uint(this.var_1429 - this.var_2267) : uint(getTimer() - this.var_2267);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_431,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_44.close();
            }
      ...
      {
         if(this.var_1153 && !_disposed)
         {
            this.var_1153 = false;
            if(!this.var_1152 && this.var_268)
            {
               this.var_1429 = -1;
               this.var_2267 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1152 && !_disposed && this.var_1430 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_268,const_1953 - this.var_1430);
            if(this.var_3058)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               this.debug("Load event STATUS " + this.var_431 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_431,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"  bytes: " + this.bytesLoaded + "/" + this.bytesTotal);
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_431,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_431))
               {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_511 = LibraryLoader.name_5;
         ...
         if(this.var_511 == LibraryLoader.const_2059)
         {
         ...
         if(this.var_511 == LibraryLoader.name_5)
         {
            if(this.prepareLibrary())
            {
               ...
               this.removeEventListeners();
               throttle();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_431,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_700 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_700.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_431,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         throttle();
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_431,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
