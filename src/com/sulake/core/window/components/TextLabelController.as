package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_411:Object = null;
      ...
      protected function get textField() : TextField
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _loc1_.textColor = uint(this.var_411);
            }
         }
         return _loc1_;
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2887 = _loc2_.textWidth;
         this.var_2886 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_411 != _loc2_.color : this.var_411 != null && this.var_411 != PropertyDefaults.const_801) ? new PropertyStruct(PropertyDefaults.const_439,this.var_411,PropertyStruct.const_177,true) : PropertyDefaults.const_1197);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_871)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,this.var_42.left,PropertyStruct.const_36,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_737);
            }
            if(this.var_42.top != PropertyDefaults.const_920)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_283,this.var_42.top,PropertyStruct.const_36,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_1019);
            }
            if(this.var_42.right != PropertyDefaults.const_903)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_309,this.var_42.right,PropertyStruct.const_36,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_970);
            }
            if(this.var_42.bottom != PropertyDefaults.const_999)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_282,this.var_42.bottom,PropertyStruct.const_36,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_865);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_439:
                  this.var_411 = _loc2_.value as uint;
                  break;
