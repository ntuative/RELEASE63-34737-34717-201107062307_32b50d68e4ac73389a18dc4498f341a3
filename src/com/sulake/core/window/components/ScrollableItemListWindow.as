package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1314:IItemListWindow;
      
      private var var_464:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_464)
         {
            this.var_464.removeEventListener(WindowEvent.const_305,this.scrollBarEventProc);
            this.var_464.removeEventListener(WindowEvent.const_260,this.scrollBarEventProc);
            this.var_464 = null;
         }
         if(this.var_1314)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1314)
         {
            this.var_1314 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_464)
         {
            this.var_464 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_464)
            {
               this.var_464.addEventListener(WindowEvent.const_305,this.scrollBarEventProc);
               this.var_464.addEventListener(WindowEvent.const_260,this.scrollBarEventProc);
            }
         }
         return this.var_464;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_260)
         {
            this.hideScrollBar();
         }
      }
