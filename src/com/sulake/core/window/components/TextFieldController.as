package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1700:uint = 500;
      ...
      {
         this.var_1413 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1242,var_10);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_873 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_196,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_402,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_906,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1891);
         _loc1_.push(this.var_1426 != PropertyDefaults.const_1295 ? new PropertyStruct(PropertyDefaults.const_984,this.var_1426,PropertyStruct.const_38,true) : PropertyDefaults.const_1763);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1324 ? new PropertyStruct(PropertyDefaults.const_884,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1915);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1262 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1969);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_906:
                  ...
                  break;
               case PropertyDefaults.const_1221:
