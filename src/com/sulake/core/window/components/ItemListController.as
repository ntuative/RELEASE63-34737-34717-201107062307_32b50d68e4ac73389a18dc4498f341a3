package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2256:Boolean = false;
      ...
      protected var var_747:Number = -1.0;
      
      protected var var_1143:Boolean = true;
      
      protected var var_504:Boolean = false;
      
      protected var var_1418:Boolean = false;
      
      protected var var_2254:int = 0;
      
      protected var var_2255:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_125 = 0;
         this.var_109 = 0;
         this._horizontal = param2 == WindowType.const_460;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_190 = var_513 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_414,WindowStyle.const_104,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_40,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_420,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_143,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_236,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1418;
      }
      ...
      {
         return new Rectangle(this.var_748 * this.maxScrollH,this.var_750 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_748)
         {
            ...
            _loc2_ = WindowEvent.allocate(WindowEvent.const_650,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_653,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_501,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_420,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_143,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_236,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_192:
               if(this.var_1416)
               {
                  this.var_1419 = this.var_2254 - _loc3_;
                  this.var_1417 = this.var_2255 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1419 != 0 && this.var_125 != 0)
                     {
                        this.scrollH += this.var_1419 / this.var_125;
                     }
                  }
                  else if(this.var_1417 != 0 && this.var_109 != 0)
                  {
                     this.scrollV += this.var_1417 / this.var_109;
                  }
                  this.var_2254 = _loc3_;
                  this.var_2255 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_312:
               if(this.var_1416)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1419,0);
                  }
                  else
                  {
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1143 && !this.var_602 && this._container)
         {
            this.var_602 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_957)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_404,this._spacing,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1265);
         }
         if(this.var_1143 != PropertyDefaults.const_1238)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_975,this.var_1143,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1897);
         }
         if(this.var_504 != PropertyDefaults.const_1366)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1031,this.var_504,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2017);
         }
         if(this.var_1418 != PropertyDefaults.const_1181)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_859,this.var_1418,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1976);
         }
         if(this.var_749 != PropertyDefaults.const_1337)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_905,this.var_749,PropertyStruct.const_133,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1881);
         }
         if(this.var_747 != PropertyDefaults.const_1281)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_747,this.var_747,PropertyStruct.const_133,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_404:
                  ...
                  break;
               case PropertyDefaults.const_1031:
               ...
               case PropertyDefaults.const_859:
                  ...
                  break;
               case PropertyDefaults.const_975:
                  this.var_1143 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_905:
                  this.var_749 = _loc2_.value as Number;
                  break;
               case PropertyDefaults.const_747:
                  this.var_747 = _loc2_.value as Number;
                  break;
            }
         }
