package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1077:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_875:String;
      
      private var var_1340:String = null;
      
      private var var_2032:StyleSheet = null;
      ...
      {
         this.var_875 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1340 == param2)
         {
            return;
         }
         param1.var_1340 = param2;
         param1.var_2032 = null;
         if(param1.var_1340 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1340);
            param1.var_2032 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_925.indexOf(param1) > -1)
         {
            this.var_875 = param1;
         }
      }
      ...
      {
         return this.var_875 == LinkTarget.const_30 ? defaultLinkTarget : this.var_875;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_2032;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1315)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_875 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_758,this.var_875,PropertyStruct.const_51,true,PropertyDefaults.const_925));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2013);
         }
         return _loc1_;
      }
