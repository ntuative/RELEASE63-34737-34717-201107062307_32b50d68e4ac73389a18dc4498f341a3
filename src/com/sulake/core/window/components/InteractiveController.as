package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_671)
         {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_904:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_671)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_904,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1963);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1357)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_840,param1.toolTipDelay,PropertyStruct.const_285,true));
         }
         else
         {
      ...
      {
         this.var_1413 = param1 == null ? "null" : param1;
      }
