package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_608 != PropertyDefaults.const_1358)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_899,this.var_608,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2021);
         }
         if(this.var_933 != PropertyDefaults.const_1236)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_824,this.var_933,PropertyStruct.const_51,true));
         }
         else
         {
