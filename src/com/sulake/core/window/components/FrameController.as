package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1578:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1534:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1534 = findChildByTag(const_1579) as IHeaderWindow;
            if(!this.var_1534)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_198 = findChildByTag(const_1576) as IWindowContainer;
            if(!this.var_198)
            {
      ...
      {
         return findChildByTag(const_1578) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1410,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_373);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_275);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_261);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,_loc3_.left,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_283,_loc3_.top,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_309,0 - _loc3_.right,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_282,0 - _loc3_.bottom,PropertyStruct.const_36,_loc2_));
         return _loc1_;
      }
