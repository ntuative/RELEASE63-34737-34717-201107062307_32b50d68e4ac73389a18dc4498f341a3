package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1417:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_932:Number;
      
      protected var var_606:Number;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_235);
         }
      ...
      {
         this.var_932 = param1;
         this._field.scrollH = this.var_932 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_932 * this.maxScrollH,this.var_606 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_987,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1214));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1319 ? new PropertyStruct(PropertyDefaults.const_874,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1274) : PropertyDefaults.const_1913);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_38,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_177,this._field.borderColor != 0));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1177 ? new PropertyStruct(PropertyDefaults.const_1355,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1369) : PropertyDefaults.const_1762);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_801) ? new PropertyStruct(PropertyDefaults.const_439,this._field.textColor,PropertyStruct.const_177,true) : PropertyDefaults.const_1197);
         _loc1_.push(this.var_453 != TextStyleManager.const_235 ? new PropertyStruct(PropertyDefaults.const_441,this.var_453,PropertyStruct.const_51,true,PropertyDefaults.const_740) : PropertyDefaults.const_1379);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_871 ? new PropertyStruct(PropertyDefaults.const_294,this.var_42.left,PropertyStruct.const_36,true) : PropertyDefaults.const_737);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_920 ? new PropertyStruct(PropertyDefaults.const_283,this.var_42.top,PropertyStruct.const_36,true) : PropertyDefaults.const_1019);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_903 ? new PropertyStruct(PropertyDefaults.const_309,this.var_42.right,PropertyStruct.const_36,true) : PropertyDefaults.const_970);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_999 ? new PropertyStruct(PropertyDefaults.const_282,this.var_42.bottom,PropertyStruct.const_36,true) : PropertyDefaults.const_865);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1200 ? new PropertyStruct(PropertyDefaults.const_901,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1880);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_133,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_133,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_133,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
