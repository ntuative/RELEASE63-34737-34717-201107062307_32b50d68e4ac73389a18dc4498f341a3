package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1474:String = "_SELECTOR";
      
      private static const const_1475:String = "_CONTENT";
       
      
      protected var var_1142:ITabSelectorWindow;
      
      protected var var_2253:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1142 = findChildByTag(const_1474) as ITabSelectorWindow;
            if(this.var_1142 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2253 = findChildByTag(const_1475) as IWindowContainer;
         }
      ...
      {
         return !!this.var_873 ? this.selector.iterator : null;
      }
