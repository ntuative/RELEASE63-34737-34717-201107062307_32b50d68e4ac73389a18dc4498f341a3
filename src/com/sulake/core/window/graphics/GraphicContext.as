package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1795:uint = 0;
      
      public static const const_934:uint = 1;
      
      public static const const_1242:uint = 2;
      
      public static const const_891:uint = 4;
      
      public static const const_1801:uint = 8;
      
      public static const const_1731:uint = 16;
      
      public static const const_2134:uint = 64;
      
      public static const const_2225:uint = 128;
      
      public static const const_1219:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1242:
               ...
               break;
            case GraphicContext.const_1801:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1731:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_891:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1219:
               break;
            case GraphicContext.const_1795:
               break;
            default:
         ...
         if(this.var_939)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2274,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2274,16777215);
                  }
                  var_364 += bitmap.width * bitmap.height * 4;
               }
