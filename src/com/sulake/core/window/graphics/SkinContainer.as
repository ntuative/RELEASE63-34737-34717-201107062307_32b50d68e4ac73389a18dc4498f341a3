package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1073:uint = 8;
      
      private static const const_1548:String = "skin";
      
      private static const const_1547:String = "bitmap";
      
      private static const const_1550:String = "fill";
      
      private static const const_1552:String = "text";
      
      private static const const_1549:String = "label";
      
      private static const const_1551:String = "shape";
      ...
      private var var_1820:Dictionary;
      
      private var var_2465:Dictionary;
      
      private var var_2464:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1820 = new Dictionary();
         this.var_2465 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1820,this.var_2465);
         this.var_2464 = new Dictionary();
         this.var_2463 = new Dictionary();
         StateCodeTable.fillTables(this.var_2464,this.var_2463);
         this.var_448 = new Dictionary();
         this.var_448[const_1548] = BitmapSkinRenderer;
         this.var_448[const_1547] = BitmapDataRenderer;
         this.var_448[const_1550] = FillSkinRenderer;
         this.var_448[const_1552] = TextSkinRenderer;
         this.var_448[const_1549] = LabelRenderer;
         this.var_448[const_1551] = ShapeSkinRenderer;
         this.var_448[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_448[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_363 == null)
         {
            var_363 = new Array();
            ...
            var_363.push(WindowState.const_90);
            var_363.push(WindowState.const_93);
            var_363.push(WindowState.const_102);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1820[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_992[param1] = new Array(const_1073);
         }
         this.var_992[param1][param2] = param3;
         if(this.var_991[param1] == null)
         {
            this.var_991[param1] = new Array(const_1073);
         }
