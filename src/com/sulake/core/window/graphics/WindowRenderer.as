package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_2106:Point;
      
      private var var_1655:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_2106 = new Point();
         this.var_1655 = new Rectangle();
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_350.x = param2.x - param1.x;
            this.var_350.y = param2.y - param1.y;
            this.var_350.width = param2.width;
            this.var_350.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_33))
            {
               while(param1.testParamFlag(WindowParam.const_33))
               {
                  ...
                  this.var_350.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_350,WindowRedrawFlag.const_1268);
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_898.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_898.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_350.x = _loc3_.dirty.x;
               this.var_350.y = _loc3_.dirty.y;
               this.var_350.width = _loc3_.dirty.width;
               this.var_350.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_350,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_2106,this.var_1655))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_2106,this.var_1655))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_33))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1655);
