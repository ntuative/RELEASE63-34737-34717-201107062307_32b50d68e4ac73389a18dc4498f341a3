   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_358 = SkinLayoutEntity.const_523;
                  break;
               case "move":
                  _loc5_.var_358 = SkinLayoutEntity.const_322;
                  break;
               case "strech":
                  _loc5_.var_358 = SkinLayoutEntity.const_568;
                  break;
               case "tiled":
                  _loc5_.var_358 = SkinLayoutEntity.const_343;
                  break;
               case "center":
                  _loc5_.var_358 = SkinLayoutEntity.const_532;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_355 = SkinLayoutEntity.const_523;
                  break;
               case "move":
                  _loc5_.var_355 = SkinLayoutEntity.const_322;
                  break;
               case "strech":
                  _loc5_.var_355 = SkinLayoutEntity.const_568;
                  break;
               case "tiled":
                  _loc5_.var_355 = SkinLayoutEntity.const_343;
                  break;
               case "center":
                  _loc5_.var_355 = SkinLayoutEntity.const_532;
            }
         }
