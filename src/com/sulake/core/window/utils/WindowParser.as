package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2308:String = "_TEMP";
      
      private static const const_1436:String = "layout";
      
      private static const const_1044:String = "window";
      
      private static const const_1043:String = "variables";
      
      private static const const_1042:String = "filters";
      
      private static const const_681:String = "name";
      
      private static const const_1437:String = "style";
      
      private static const const_683:String = "params";
      
      private static const const_1426:String = "tags";
      ...
      private static const const_1427:String = "visible";
      
      private static const const_1428:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1229:String = "blend";
      
      private static const const_1435:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1424:String = "treshold";
      
      private static const const_1432:String = "children";
      
      private static const const_1430:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1429:String = "height_min";
      
      private static const const_1423:String = "height_max";
      ...
      private static const const_1425:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1431:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1433:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1411:Dictionary;
      
      protected var var_1412:Dictionary;
      
      protected var var_1141:Dictionary;
      
      protected var var_1699:Dictionary;
      
      protected var var_2248:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1411,this.var_1412);
         this.var_1141 = new Dictionary();
         this.var_1699 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1141,this.var_1699);
         this.var_2248 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1433,const_50);
         return param1.replace(const_1431,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1411)
            {
               delete this.var_1411[_loc1_];
            }
            for(_loc1_ in this.var_1412)
            {
               delete this.var_1412[_loc1_];
            }
            for(_loc1_ in this.var_1141)
            {
               delete this.var_1141[_loc1_];
            }
            for(_loc1_ in this.var_1699)
            {
               delete this.var_1699[_loc1_];
            }
            this.var_2248.dispose();
            this.var_2248 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1436)
         {
            _loc8_ = param1.child(const_1043);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1042).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1044);
         ...
         if(param1.localName() == const_1044)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1411[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_681,variables,"")));
         style = uint(this.parseAttribute(xml,const_1437,variables,style));
         params = uint(this.parseAttribute(xml,const_683,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1426,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1427,variables,visible.toString()) == const_682;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_683).length() > 0)
         {
            list = xml.child(const_683).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               ...
               if(this.var_1141[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_681)) + "\"!");
               }
               params |= this.var_1141[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1428,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1425);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1043)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1430,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1429,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1423,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_682;
         blend = Number(this.parseAttribute(xml,const_1229,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1435,variables,window.clipping.toString()) == const_682;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1424,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1042).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_224)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1412[param1.type];
