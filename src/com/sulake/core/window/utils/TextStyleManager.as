package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_235:String = "regular";
      ...
      private static var var_584:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_724:String = "{";
      
      private static const const_723:String = "}";
      
      private static const const_1704:String = "/*";
      
      private static const const_1705:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_101[const_235],var_101[ITALIC],var_101[BOLD]];
            var_101.reset();
            var_101[const_235] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_584.indexOf(_loc4_.name) == -1)
            {
               var_584.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_723);
         if(countSubStrings(param1,const_724) != countSubStrings(param1,const_723))
         {
            throw new Error("Mismatching amount of \"" + const_724 + "\" versus \"" + const_723 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1704) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1705) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_724)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
