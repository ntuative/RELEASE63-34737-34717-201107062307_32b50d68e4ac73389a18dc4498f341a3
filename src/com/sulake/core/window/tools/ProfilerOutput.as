package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1510:Class = ProfilerOutput_profiler_dialog_xml;
      ...
      private var var_176:IProfiler;
      
      private var var_25:ICore;
      
      private var _window:IFrameWindow;
      
      private var var_3075:Array;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3075 = new Array();
         this.var_176 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1510() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_176)
         {
            this.var_176.removeStopEventListener(this.refresh);
            this.var_176 = null;
         }
         if(!this.var_176 && param1)
         {
            this.var_176 = param1;
            this.var_176.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_616)
            {
               this.var_1836 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_176.getProfilerAgentsInArray();
         ...
         if(this.var_1836)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_176.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_176.numBitmapAssetInstances + " / " + this.var_176.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_176.numTrackedBitmapDataInstances + " / " + this.var_176.numTrackedBitmapDataBytes + " bytes";
         }
      }
