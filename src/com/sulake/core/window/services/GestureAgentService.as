package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         {
            this._window = param1;
            this._window.addEventListener(WindowEvent.const_355,this.clientWindowDestroyed);
            this.var_316 = param2;
            this._working = true;
            this.var_1423 = param4;
            this.var_1422 = param5;
            this.var_222 = new Timer(40,0);
            this.var_222.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_222.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         ...
         {
            this.var_316(this.var_1423,this.var_1422);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_222.stop();
            this.var_222.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_222 = null;
         }
         if(this._working)
         {
            if(this._window == param1)
            {
               ...
               {
                  this._window.removeEventListener(WindowEvent.const_355,this.clientWindowDestroyed);
               }
               this._window = null;
               this._working = false;
            }
