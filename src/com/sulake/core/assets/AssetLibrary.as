package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1222:String = "AssetLibraryReady";
      
      public static const const_751:String = "AssetLibraryLoaded";
      
      public static const const_1885:String = "AssetLibraryUnloaded";
      
      public static const const_1808:String = "AssetLibraryLoadError";
      
      private static const const_681:String = "name";
      
      private static const const_1125:String = "asset";
      
      private static const const_1124:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1126:String = "library";
      
      private static var var_346:Dictionary;
      
      private static var var_2050:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_568:uint = 0;
      
      private static var var_1086:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_568;
         this.var_473 = new Dictionary(false);
         this.var_567 = new Dictionary(false);
         this.var_1087 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_701 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1126);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1125);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1124);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_701 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1086.splice(var_1086.indexOf(this),1);
            --var_568;
            this.var_567 = null;
            this.var_1087 = null;
            this.var_184 = null;
      ...
      {
         if(this.var_701 == param1.url && this.var_1085)
         {
            if(!this.var_1084 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_700);
            }
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_1087)
         {
            delete this.var_1087[_loc1_];
         }
         if(this.var_44 != null)
         {
            this.var_44.dispose();
         ...
         this.var_1085 = false;
         this.var_701 = null;
         dispatchEvent(new Event(AssetLibrary.const_1885));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1087[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_567[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1350,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1302,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1216,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1326,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_567[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_567[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_474;
                     this.var_472.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_567[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_472.length ? this.getAssetByName(this.var_472[param1]) : null;
      }
      
      public function method_12(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_184)
         {
            ...
            {
               return this.var_472.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_184[param1] != null || (this.var_700 != null ? this.var_700[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_2050.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_184)
            {
               if(this.var_184[_loc2_] == param1)
               {
                  this.var_472.splice(this.var_472.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_346.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_346[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_473.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_473[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_346[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_473[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_346)
            {
               _loc3_ = AssetTypeDeclaration(var_346[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_473)
         {
            _loc3_ = AssetTypeDeclaration(this.var_473[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_346)
            {
               _loc4_ = AssetTypeDeclaration(var_346[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_473)
         {
            _loc4_ = AssetTypeDeclaration(this.var_473[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_700 = _loc2_.resource;
         this.var_701 = _loc2_.url;
         if(this.var_1084)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_700);
         }
         this.var_1085 = true;
         dispatchEvent(new Event(AssetLibrary.const_751));
         dispatchEvent(new Event(AssetLibrary.const_1222));
         if(this.var_1084)
         {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1126);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1125);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_681) && _loc3_.attribute(const_681).toString() == param1)
                  {
                     ...
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_701 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_700[param1]);
                     _loc6_ = _loc3_.child(const_1124);
