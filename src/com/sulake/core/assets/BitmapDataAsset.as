package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_549:uint = 0;
      ...
      private var var_1808:AssetTypeDeclaration;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_549 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_123 is BitmapDataAsset)
         {
            ...
            this.var_1662 = BitmapDataAsset(this.var_123).var_1662;
            this.var_1661 = BitmapDataAsset(this.var_123).var_1661;
            if(this._bitmap != null)
            {
               this.var_123 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1662 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1661 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
