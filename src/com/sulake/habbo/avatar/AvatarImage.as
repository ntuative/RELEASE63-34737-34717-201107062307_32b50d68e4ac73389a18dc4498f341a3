package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1574:String = "Default";
      
      private static const const_1575:int = 2;
      
      private static const const_1573:String = AvatarSetType.const_41;
      ...
      protected var var_314:IActiveActionData;
      
      protected var var_1147:Boolean;
      
      protected var var_902:Array;
      ...
      private var var_1024:IActiveActionData;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1573,const_1575);
         this.var_361 = new Array();
         this.var_1024 = new ActiveActionData(AvatarAction.const_425);
         this.var_1024.definition = this._structure.getActionDefinition(const_1574);
         this.resetActions();
      ...
      {
         param2 += this.var_1889;
         if(param2 < AvatarDirectionAngle.const_1293)
         {
            param2 = AvatarDirectionAngle.const_385 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_385)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_58 || param1 == AvatarSetType.const_41)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_660,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_282.length == 1 && this.var_102 == this.var_2047)
         {
            return this.var_102 + this.var_544 + this.var_660 % 4;
         }
         if(this.var_282.length == 2)
         {
            for each(_loc1_ in this.var_282)
            {
               ...
               {
                  return this.var_102 + this.var_544 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_660 % 11;
                  return this.var_102 + "_" + this.var_2047 + this.var_544 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2578 || param2 != this.var_2577 || param1 != this.var_2579)
         {
            this.var_2578 = param3;
            this.var_2577 = param2;
            this.var_2579 = param1;
            this.var_1890 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_314.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1425 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1425)
            {
               this.var_48.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_314.definition.geometryType,this.var_102);
         this.var_48.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_660);
         ...
         if(this.var_604 != null)
         {
            if(this.var_604.paletteIsGrayscale)
            {
               ...
               this.var_48 = _loc13_;
               this.var_48.paletteMap(this.var_48,this.var_48.rect,new Point(0,0),this.var_604.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_314.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_314.definition.geometryType,this.var_102);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_660);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_361.push(new ActiveActionData(param1,param2,this.var_660));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_314 = this.var_1024;
         this.var_314.definition = this.var_1024.definition;
         this.resetBodyPartCache(this.var_1024);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_544 = "";
         this.var_282 = this._structure.sortActions(this.var_361);
         if(this.var_282 == null)
         {
            this.var_902 = new Array(0,0,0);
            if(this.var_1256 != "")
            {
               _loc1_ = true;
               this.var_1256 = "";
         ...
         {
            this.var_902 = this._structure.getCanvasOffsets(this.var_282,this._scale,this.var_102);
            for each(_loc4_ in this.var_282)
            {
               this.var_544 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_348)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1533 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1256 != this.var_544)
            {
               _loc1_ = true;
               this.var_1256 = this.var_544;
            }
         }
         this.var_1532 = true;
         return _loc1_;
            ...
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1889 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_350 || _loc1_.actionType == AvatarAction.const_258 || _loc1_.actionType == AvatarAction.const_416)
               {
                  this.var_1025 = true;
               }
            }
