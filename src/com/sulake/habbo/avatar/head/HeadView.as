   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_40)
         {
            ...
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_228,_windowManager,_assetLibrary);
            ...
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_277,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_78 && var_166 == "")
         {
            var_78.switchCategory(FigureData.const_228);
         }
      }
