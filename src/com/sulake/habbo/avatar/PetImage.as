   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_58)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1545);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_314.definition.geometryType);
         if(this.var_48 == null || _loc4_ != null && (this.var_48.width != _loc4_.width || this.var_48.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_314.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_660);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_660);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_660);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_660);
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_544 = this.var_544 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_445:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1830:
                  case AvatarAction.const_1985:
                  case AvatarAction.const_1203:
                  case AvatarAction.const_1209:
                  case AvatarAction.const_1921:
                  case AvatarAction.const_1899:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1024);
         this.getCache().resetBodyPartCache(this.var_1024);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1544 = this._structure.sortActions(this.var_361);
         ...
         {
            this.var_902 = this._structure.getCanvasOffsets(this.var_1544,this._scale,this.var_102);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1544)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_350)
               {
                  this.var_1025 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1362 = _loc4_.id;
                     this.var_1907 = _loc4_.breed;
                     break;
                  }
               }
            }
