package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      private var var_186:AvatarRenderManager;
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               if(this.var_439.getValue(_loc4_) == null)
               {
                  this.var_439.add(_loc4_,new PetData(_loc3_));
               }
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_529 == null)
         {
            return;
         }
         var _loc2_:int = this.var_529.indexOf(param1);
         if(_loc2_ != -1)
         {
      ...
      private function notifyListeners() : void
      {
         ...
         {
            _loc1_ = this.var_529.pop() as IPetDataListener;
      ...
      {
         var _loc3_:IPetData = this.var_439.getValue(param1) as IPetData;
         if(_loc3_ == null)
         {
      ...
      public function createPetFigureString(param1:int, param2:int, param3:uint) : String
      {
         ...
         var _loc4_:PetData = this.var_439.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = this.var_439.getKeys();
         for each(key in speciesKeys)
         {
            petData = this.var_439.getValue(key);
            if(petData != null)
            {
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         if(param2 == AvatarScaleType.const_113)
         {
            _loc5_ = 0;
         ...
         {
            if(this.var_1473.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_627.getValue(_loc6_) == null)
               {
                  ...
                  if(param3 != null && this.var_529.indexOf(param3) == -1)
                  {
                     this.var_529.push(param3);
                  }
               }
            }
         }
      ...
      private function method_7(param1:LibraryLoader) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc5_:* = null;
