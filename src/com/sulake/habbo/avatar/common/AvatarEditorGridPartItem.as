package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_796:IFigurePartSet;
      ...
      private const const_2351:int = 13421772;
      
      private const const_2352:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_745 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1792 = Math.max(this.var_1792,_loc6_.colorLayerIndex);
            }
         }
         this.var_442 = this.var_78.controller.manager.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_745 != null && !this.var_1794)
            {
               _loc3_ = this.var_745;
            }
            else
            ...
            if(this.var_796)
            {
               switch(this.var_796.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_43:
                     _loc2_.style = HabboIconType.const_1011;
               }
            }
            else
            {
         ...
         if(this.isSelected)
         {
            this.var_1487.color = this.const_2351;
         }
         else
         {
            this.var_1487.color = this.const_2352;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_387[_loc6_] + "_" + FigureData.const_159;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_633 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1793)
               {
                  ...
                  this.var_1793 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_633.width,this.var_633.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_633.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_633.y;
