package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_856 = new ColorTransform(this.var_1850,this.var_1851,this.var_1852,this._alphaMultiplier);
         this.var_1374 = this.generatePaletteMapForGrayscale(this.var_2890,this.var_2892);
      }
      ...
      {
         return this.var_1374.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1374.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1374.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1374.getValue("alphas") as Array;
      }
