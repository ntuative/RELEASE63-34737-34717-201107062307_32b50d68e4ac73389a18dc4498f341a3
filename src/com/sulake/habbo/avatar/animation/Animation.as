package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_2093:AvatarDataContainer;
      
      private var var_1643:Array;
      
      private var var_2094:DirectionDataContainer;
      
      private var var_2095:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1913 = String(param2.@desc);
         }
         else
         {
            this.var_1913 = this._id;
         }
         ...
         {
            this.var_2093 = new AvatarDataContainer(param2.avatar[0]);
         }
         ...
         {
            this.var_2094 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_2095 = new ShadowDataContainer(param2.shadow[0]);
         }
         ...
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_895.push(new AddDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("override"))
         {
            ...
            for each(_loc7_ in param2.name_6)
            {
               ...
               this.var_711.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc8_ in _loc7_.bodypart)
            {
               ...
               _loc10_ = new AnimationLayerData(param3,_loc8_,AnimationLayerData.const_805,_loc6_,_loc5_);
               _loc4_.push(_loc10_);
            }
      ...
      public function overridingAction(param1:String) : String
      {
         ...
         return this.var_711.getValue(param1);
      }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         {
            if(_loc4_.type == AnimationLayerData.const_805)
            {
      ...
      {
         return this.var_2094 != null;
      }
      
      public function hasShadowData() : Boolean
      {
         return this.var_2095 != null;
      }
