package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_969:int = 3;
      
      private var var_438:AssetLoaderStruct;
      
      private var var_970:Timer;
      ...
      private const const_2347:int = 100;
      
      private const const_1770:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_438 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_970 = new Timer(this.const_2347,1);
         this.var_970.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_438)
         {
            this.var_438.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,this.onConfigurationComplete);
            this.var_438.addEventListener(AssetLoaderEvent.const_42,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_438)
         {
            this.var_438.removeEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,this.onConfigurationComplete);
            this.var_438.removeEventListener(AssetLoaderEvent.const_42,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         if(this.var_969 <= 0)
         {
            HabboWebTools.logEventLog("Figuremap download error " + this.var_1185);
            Logger.log("AVATAR ASSET ERROR: Could not download figuremap.xml.");
         }
         else
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_969);
            if(this.var_1185.indexOf("?") > 0)
            {
               _loc2_ = this.var_1185 + "&retry=" + this.var_969;
            }
            else
            {
               _loc2_ = this.var_1185 + "?retry=" + this.var_969;
            ...
            this.var_438 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2357,this._assets);
            _loc3_.addEventListener(Event.COMPLETE,this.libraryComplete);
            for each(_loc4_ in _loc2_.part)
            {
               _loc5_ = _loc4_.@type + ":" + _loc4_.@id;
               _loc6_ = this.var_1186[_loc5_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(_loc3_);
               this.var_1186[_loc5_] = _loc6_;
            }
         }
      }
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1758)
         {
            this.var_1187.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_529[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_529[_loc3_] = _loc6_;
            }
            this.var_968[_loc3_] = _loc4_;
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_968)
         {
            _loc7_ = true;
            _loc4_ = this.var_968[_loc3_];
            ...
            if(_loc7_)
            {
               ...
               delete this.var_529[_loc3_];
            }
         }
         for each(_loc3_ in _loc2_)
         {
            delete this.var_968[_loc3_];
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_780.length > 0 && this.var_781.length < this.const_1770)
         {
