package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1634:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1633:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1058:IFigureData;
      ...
      private var var_1306:IHabboAvatarEditorDataSaver = null;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_560 = param2;
         this.var_1058 = this.var_560.avatarRenderManager.getFigureData(AvatarType.const_127);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         _loc2_.loadAvatarData(const_1634,FigureData.const_89);
         _loc3_.loadAvatarData(const_1633,FigureData.FEMALE);
         this.var_118 = new Map();
         this.var_559 = new Map();
         this.var_118.add(AvatarEditorFigureCategory.const_823,new BodyModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_58,new HeadModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_245,new TorsoModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_1021,new LegsModel(this));
         ...
         this.var_559.add(AvatarEditorSideCategory.const_115,new WardrobeModel(this));
         this.var_559.add(AvatarEditorSideCategory.const_624,new ClubPromoModel(this));
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1058.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1058.getPalette(param1);
      }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_823);
         }
      }
      ...
      {
         return this.var_682[this.var_1030];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1306.saveFigure(_loc1_,_loc2_);
         }
         else
         {
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1971;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_853 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_707)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1697.clone() as IWindowContainer,param1,_loc13_);
                     _loc4_[_loc17_].push(_loc18_);
                     _loc17_++;
                  }
                  if(param2 != FigureData.const_88)
                  {
                     _loc19_ = 0;
            ...
            _loc16_ = param2 != FigureData.const_88;
            for each(_loc6_ in _loc8_.partSets)
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1954)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_853 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_853 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_559.getValue(AvatarEditorSideCategory.const_115);
      }
