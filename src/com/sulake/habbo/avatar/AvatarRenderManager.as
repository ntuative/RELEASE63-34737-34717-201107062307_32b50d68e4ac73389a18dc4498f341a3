package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_922:PaletteManager;
      ...
      private var var_2175:AvatarFigureContainer;
      
      private var var_3024:Boolean = false;
      
      private var var_3025:Boolean = false;
      
      private var var_3023:Boolean = false;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_661 = RenderMode.const_1947;
         ...
         this.var_124.add(AvatarType.const_127,_loc4_);
         ...
         this.var_354 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_922 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_354.populateFigureData(_loc5_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_354.init();
         this.var_922.init();
         _loc2_ = this.var_124.getValue(AvatarType.const_127) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_124.getValue(AvatarType.const_127) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_142.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_265 == null)
               {
                  ...
                  _loc6_ = this.var_142.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_142.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1085)
         {
            if(this.var_3024 && this.var_3025 && this.var_3023)
            {
               this.var_1085 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_124.getValue(AvatarType.const_127) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_2175)
         {
            this.var_2175 = new AvatarFigureContainer(this.const_2380);
         }
         this.var_265.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2175,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(param1 == null || this.var_353 == null)
         {
            return;
         }
         for each(_loc2_ in this.var_353.getKeys())
         {
            _loc3_ = this.var_353.getValue(_loc2_);
            if(_loc3_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_354.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1846)
         {
            _loc6_ = !this.var_354.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_354.createPetFigureString(param1,param2,param3);
         ...
         if(param5 != null)
         {
            ...
            this.var_353.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_354.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_124.getValue(AvatarType.const_57);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_353.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_353.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_124.getValue(AvatarType.const_127) as AvatarStructure;
      ...
      {
         return this.var_354 as IPetDataManager;
      }
