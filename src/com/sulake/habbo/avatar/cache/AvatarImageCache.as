package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_2071:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1651:IAvatarImage;
      ...
      private var var_2422:ByteArray;
      
      private var var_2421:ImageData;
      
      private var var_1116:PaletteMap;
      
      private var var_979:Array;
      
      private var var_981:Point;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_792 == GeometryType.const_1176 && param1 == GeometryType.const_1186 || this.var_792 == GeometryType.const_1186 && param1 == GeometryType.const_1176)
         {
            this.var_792 = param1;
            this.var_98 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_378.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_805)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1651.getFigure(),_loc5_,this.var_792,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_492 == null)
         {
            ...
            this.var_492 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_378);
            if(this.var_492 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_98)
         {
            ...
            this.var_2423 = new Point(0,this.var_98.height - int(this.var_98.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1961[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_1017 || _loc10_ == AvatarAction.const_416;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1483 = this.var_127.bodyPartId;
               this.var_196 = this.var_127.partType;
               this.var_1787 = this.var_127.partId;
               ...
               this.var_1482 = this._scale + "_" + this.var_127.action.assetPartDefinition + "_" + this.var_196 + "_" + this.var_1787 + "_" + _loc5_ + "_" + this._frame;
               this.var_440 = this._assets.getAssetByName(this.var_1482) as BitmapDataAsset;
               if(this.var_440 == null)
               {
                  this.var_1482 = this._scale + "_std_" + this.var_196 + "_" + this.var_1787 + "_" + _loc5_ + "_0";
                  this.var_440 = this._assets.getAssetByName(this.var_1482) as BitmapDataAsset;
               }
               if(!(!this.var_440 || !this.var_440.content))
               {
                  if(this.var_127.paletteMapId > -1)
                  {
                     this.var_1116 = this._structure.renderManager.paletteManager.getPalette(this.var_127.paletteMapId);
                     if(this.var_1116 != null)
                     {
                        this.var_980 = this.var_440.content as BitmapData;
                        this.var_195 = new BitmapData(this.var_980.width,this.var_980.height);
                        this.var_2422 = this.var_1116.colorize(this.var_980.getPixels(this.var_980.rect));
                        this.var_195.setPixels(this.var_195.rect,this.var_2422);
                     }
                     else
                     {
                        this.var_195 = (this.var_440.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1483 == AvatarBodyPartType.const_245 || this.var_1483 == AvatarBodyPartType.const_1878 || this.var_1483 == AvatarBodyPartType.const_1768) && this.var_127.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  this.var_981 = this.var_440.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_62)
                     {
                  ...
                  this.var_2421 = new ImageData(this.var_195,this.var_981,_loc7_);
                  this.var_979.push(this.var_2421);
               }
            }
            _loc8_--;
         }
         ...
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2423.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_62)
            {
