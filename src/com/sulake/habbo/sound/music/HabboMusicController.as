package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1697:int = HabboMusicPrioritiesEnum.const_126;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_791.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_791.push(new UserSongDisksInventoryMessageEvent(this.method_11));
         for each(_loc5_ in this.var_791)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_997,this.onJukeboxInit);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_297,this.onJukeboxDispose);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_949,this.onSoundMachineInit);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_745,this.onSoundMachineDispose);
         this.var_1375 = new Timer(1000);
         this.var_1375.start();
         this.var_1375.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2108)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_461)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_95)
            {
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_997,this.onJukeboxInit);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_297,this.onJukeboxDispose);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_949,this.onSoundMachineInit);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_745,this.onSoundMachineDispose);
            }
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_715.add(param1,param2);
      ...
      {
         if(param1 >= 0 && param1 < this.var_413.length)
         {
            return this.var_413.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_413.length)
         {
            return this.var_413.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_305.length)
         {
            ...
            if(_loc3_.id != this.var_1656 && _loc4_ != null && _loc4_.ready)
            {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_899));
         Logger.log("Requested song info\'s : " + this.var_899);
         this.var_899 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_900.indexOf(_loc6_.id) != -1)
               {
                  this.var_900.splice(this.var_900.indexOf(_loc6_.id),1);
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.var_2108 = this.getSongRequestCountAtPriority(param1);
         this.var_1656 = param2;
         if(this._priorityPlaying <= const_1697)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_126)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_137,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2903 != param1.id || _loc3_ > this.var_2904 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2903 = param1.id;
            this.var_2904 = _loc3_;
         }
      }
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_715.getValue(param1);
      }
      ...
      private function method_11(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_413.add(_loc5_,_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_574 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_95,this._connection) as IPlayListController;
      }
