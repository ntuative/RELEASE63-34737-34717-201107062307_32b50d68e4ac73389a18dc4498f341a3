package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_721:uint = 1;
      ...
      private var var_1215:IRoomSession;
      ...
      private var var_234:CatalogViewer;
      
      private var var_262:ICatalogNavigator;
      
      private var var_116:Purse;
      
      private var var_106:RecyclerLogic;
      
      private var var_162:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var _confirmationDialog:PurchaseConfirmationDialog;
      
      private var var_233:ChargeConfirmationDialog;
      ...
      private var var_2937:GiftWrappingConfiguration;
      
      private var var_1379:ClubGiftController;
      
      private var var_579:ClubBuyController;
      
      private var var_720:ClubExtendController;
      
      private var var_905:Map;
      
      private var var_1380:Boolean = false;
      
      private var var_904:IPurchasableOffer;
      
      private var var_1665:IDragAndDropDoneReceiver;
      ...
      private var var_721:RoomPreviewer;
      
      private const const_2101:Point = new Point(100,20);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1876);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_418.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_579.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         this.var_142 = param2 as IHabboConfigurationManager;
         this.var_2939 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_418.loadProductData(this);
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_178,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_142 != null && this.var_142.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_721 == null)
            {
               this.var_721 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_142.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_873 || !this.var_262 || !this.var_262.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1113 = -1;
            this.var_903 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_262.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_142.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_142.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_418.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_418.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_65)
         {
            _loc3_ = this.var_418.method_4(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_905.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_234.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_262 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_234 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_234.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:String = "catalog";
         if(this.var_142.getBoolean("catalog.show.purse",false))
         {
            _loc1_ = "catalog_with_purse";
         }
         var _loc2_:XmlAsset = assets.getAssetByName(_loc1_) as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_721) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2101;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_76:
               this.var_2123 = param1.session.isPrivateRoom;
               this.var_1215 = param1.session;
               if(this.var_106 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_162 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1379 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_579 == null)
         {
            this.var_579 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_720 == null)
         {
            this.var_720 = new ClubExtendController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_234 != null)
         {
            this.var_234.catalogWindowClosed();
         }
         if(this.var_106 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_106.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1664 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_262.buildCatalogIndex(_loc2_);
         if(this.var_903 && this.var_903 != "")
         {
            this.var_262.openPage(this.var_903);
            this.var_903 = "";
            this.var_1113 = -1;
         }
         else if(this.var_1113 > -1)
         {
            this.var_262.openPageById(this.var_1113,this.var_2124);
            this.var_1113 = -1;
            this.var_2124 = -1;
            this.var_903 = "";
         }
         else if(this.var_1664 && this.var_2939)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_262.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_2011));
         }
         else
         {
            this.var_262.loadFrontPage();
         }
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_234.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_234 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_234.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2940 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1333);
         }
         this.var_2940 = false;
         if(this.var_233 != null && !this.var_233.disposed)
         {
            this.var_233.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_131,this.var_116.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2938 && this._soundManager != null)
         {
         ...
         if(_loc2_.type == ActivityPointTypeEnum.const_942)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_370,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_370,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_116.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1377 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1379.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_162 != null)
         {
            this.var_162.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_162 != null)
         {
            this.var_162.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_162 != null)
         {
            this.var_162.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2937 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_162.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onHabboClubOffers(param1:HabboClubOffersMessageEvent) : void
      {
         if(this.var_579 != null)
         {
            this.var_579.onOffers(param1);
         }
      }
      
      private function onHabboClubExtendOffer(param1:HabboClubExtendOfferMessageEvent) : void
      {
         if(this.var_720 != null && this.var_142.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_720.onOffer(param1);
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_233 == null || this.var_233.disposed)
         {
            this.var_233 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_233.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_905.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_905.add(_loc2_.productCode,_loc3_.slice());
            this.var_234.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_142.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_142.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_167)
         {
            _loc3_ = this.var_142.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_142.keyExists("catalog.drag_and_drop") || this.var_142.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1215 || !this.var_1215.isRoomOwner)
         {
            return false;
         }
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_217);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_227);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1380 && param1.type == RoomEngineObjectEvent.const_178)
         {
            this.resetPlacedOfferData(true);
            if(this.var_904 == null || this.var_904.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_904.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_66 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_904);
            _loc5_ = this.var_1665;
            if(_loc5_ != null)
            {
            ...
            if(this.var_66.roomCategory == this._roomEngine.activeRoomCategory && this.var_66.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_327:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_217);
                  ...
                  case FurniCategory.const_358:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_227);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_142.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_721);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_721 != null)
         {
            this.var_721.updatePreviewRoomView();
         }
      }
   }
}
