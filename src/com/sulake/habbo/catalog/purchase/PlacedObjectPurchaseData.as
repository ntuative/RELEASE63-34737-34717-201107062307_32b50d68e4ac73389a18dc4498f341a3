package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_1964:IProductData;
      ...
      {
         this.var_1282 = param1.offerId;
         this.var_1963 = param1.productContainer.firstProduct.productClassId;
         this.var_1964 = param1.productContainer.firstProduct.productData;
         this.var_697 = param1.productContainer.firstProduct.furnitureData;
         this.var_1556 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_237,this._category,this.var_2013,this._x,this.var_174,this._direction,this.var_1282,this.var_1963].toString();
      }
