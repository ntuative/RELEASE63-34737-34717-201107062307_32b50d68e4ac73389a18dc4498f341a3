package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_1725:String = "your_price_icon";
      
      private static const const_1726:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1728:String = "image/png";
      
      private static const const_1727:int = 2000;
      
      private static const const_1724:int = 75;
      
      protected static const const_2063:uint = 0;
      ...
      private var var_740:IRegionWindow;
      
      private var var_741:ITextWindow;
      
      private var var_425:IBitmapWrapperWindow;
      
      private var var_739:Vector.<BitmapData>;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_27 = param1;
         this.var_105 = param2;
         this.var_739 = new Vector.<BitmapData>(const_393);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_740)
         {
            this.var_740.removeEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
            this.var_740.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
            this.var_740 = null;
         }
         if(this.var_741)
         {
         ...
         if(this.var_739)
         {
            ...
            {
               this.var_739[_loc1_].dispose();
               this.var_739[_loc1_] = null;
               _loc1_++;
            }
            this.var_739 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_740 = this._view.findChildByName("maybe_later_region") as IRegionWindow;
         this.var_741 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_740 || !this.var_741)
         {
            return;
         }
         this.var_740.addEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
         this.var_740.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1726,const_1728,this.onTeaserLoaded);
         ...
         this.var_425 = this._view.findChildByName(const_1725) as IBitmapWrapperWindow;
         ...
         while(_loc8_ < const_393)
         {
            ...
            this.var_739[_loc8_] = _loc10_.clone();
            _loc8_++;
         }
         this.startAnimation();
      }
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_741)
         {
            this.var_741.textColor = const_2063;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_741)
         {
            this.var_741.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_923 = new Timer(const_1727);
         this.var_923.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_923.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_425.bitmap)
         {
            this.var_425.bitmap.dispose();
         }
         if(this.var_738 < const_393)
         {
            this.var_425.bitmap = new BitmapData(this.var_425.width,this.var_425.height,true,0);
            this.var_425.bitmap.copyPixels(this.var_739[this.var_738],this.var_739[this.var_738].rect,new Point(0,0));
         }
         else
         {
      ...
      {
         this.var_495 = new Timer(const_1724,const_393 - 1);
         this.var_495.addEventListener(TimerEvent.TIMER,this.onAnimationFrame);
         this.var_495.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationFrameComplete);
         this.var_495.start();
      }
