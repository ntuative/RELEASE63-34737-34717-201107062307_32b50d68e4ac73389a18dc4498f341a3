package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_526:IDisplayObjectWrapper;
      
      private var var_1742:Point;
      
      private var var_527:IItemGridWindow;
      
      private var var_1456:IScrollbarWindow;
      
      protected var var_1919:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_964 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1176 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_194 != null)
         {
            ...
            this.var_526 = this.var_194.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_526 != null && _loc3_ != null)
            {
               this.var_194.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_526.width,this.var_526.height);
               if(_loc4_ != null)
               {
                  this.var_526.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1742 = new Point(this.var_97.x,this.var_97.y);
         this.var_527 = _window.findChildByName("bundleGrid") as IItemGridWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_527 != null)
         {
            this.var_527.visible = false;
            this.var_527.destroyGridItems();
         }
         ...
         this.var_964.text = _loc4_;
         this.var_1176.text = _loc5_;
         this.var_964.height = this.var_964.textHeight + 5;
         this.var_1176.y = this.var_964.y + this.var_964.height;
         this.var_1176.height = Math.max(130,this.var_1176.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_571:
                  _loc6_ = this._bundlePreview.clone();
                  if(this.var_527 != null)
                  {
                     this.var_527.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_527,this.var_1456,this.var_1919);
                     this.var_527.scrollV = 0;
                  }
                  if(this.var_194 != null)
                  {
                     this.var_194.visible = false;
               ...
               case Offer.const_458:
                  _loc9_ = _loc2_.productContainer.firstProduct;
                  if(this.var_194 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_73 || _loc9_.productType == ProductTypeEnum.const_65 || _loc9_.productType == ProductTypeEnum.const_198)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_73:
                        if(_loc8_ != null && this.var_526 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_342,AvatarAction.const_594);
                                 _loc18_.appendAction(AvatarAction.const_348,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2325)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_97 != null && true)
         {
            ...
            this.var_97.x = this.var_1742.x;
            this.var_97.y = this.var_1742.y;
            if(param3 != null)
            {
