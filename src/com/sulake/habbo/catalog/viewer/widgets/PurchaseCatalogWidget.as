package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_2840:XML;
      
      private var var_2837:XML;
      
      private var var_2838:XML;
      
      private var var_2835:XML;
      
      private var var_2839:XML;
      
      private var var_1095:IWindowContainer;
      
      private var var_709:IButtonWindow;
      
      private var var_3119:IButtonWindow;
      
      private var var_2073:IButtonWindow;
      ...
      private var var_3086:ITextWindow;
      
      private var var_105:Offer;
      
      private var var_2074:String = "";
      
      private var var_1629:Function;
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2836 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2840 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2837 = _loc3_.content as XML;
         }
      ...
      private function attachStub(param1:String, param2:int) : void
      {
         ...
         if(this.var_32.hasUserRight(null,param2))
         {
            switch(param1)
            {
               case Offer.const_827:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2836) as IWindowContainer;
                  break;
               case Offer.const_1256:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2840) as IWindowContainer;
                  break;
               case Offer.const_1251:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2837) as IWindowContainer;
                  break;
               default:
         ...
         else
         {
            switch(param2)
            {
               case HabboClubLevelEnum.const_35:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2838) as IWindowContainer;
                  break;
               case HabboClubLevelEnum.const_43:
                  if(!this.var_32.hasUserRight(null,HabboClubLevelEnum.const_35))
                  {
                     _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2835) as IWindowContainer;
                  }
                  else
                  {
                     _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2839) as IWindowContainer;
                  }
            }
         }
         if(_loc3_ != null)
         {
            ...
            {
               _window.removeChild(this.var_1095);
               this.var_1095.dispose();
            }
            this.var_1095 = _loc3_;
            _window.addChild(_loc3_);
            this.var_1095.x = 0;
            this.var_1095.y = 0;
         }
         this.var_2077 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_2075 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_2076 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_3086 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_709 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         this.var_2073 = window.findChildByName("ctlg_buy_club_button") as IButtonWindow;
         if(this.var_709 != null)
         {
            if(this.var_1629 != null)
            {
               this.var_709.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1629);
            }
            else
            {
               this.var_709.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1629);
               this.var_709.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onPurchase);
            }
            this.var_709.disable();
         }
         if(this.var_2073 != null)
         {
            this.var_2073.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onBuyClub);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_2077 != null)
         {
            ...
            this.var_2077.caption = "${catalog.purchase.price.credits}";
         }
         ...
         if(this.var_2075 != null)
         {
            ...
            this.var_2075.caption = _loc2_.getKey(_loc4_);
         }
         if(this.var_2076 != null)
         {
            ...
            this.var_2076.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_2074 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         ...
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_105,page.pageId,this.var_2074);
         }
      }
      ...
      private function initPurchase(param1:CatalogWidgetInitPurchaseEvent) : void
      {
         if(this.var_105 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_105,page.pageId,this.var_2074,param1.enableBuyAsGift);
         }
      }
      
      private function onBuyClub(param1:WindowMouseEvent) : void
      {
         (page.viewer.catalog as HabboCatalog).openCatalogPage(CatalogPageName.const_141,true);
