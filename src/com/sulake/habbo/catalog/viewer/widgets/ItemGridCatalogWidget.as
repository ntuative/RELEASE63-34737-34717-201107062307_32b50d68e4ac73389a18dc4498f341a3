package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_506:IItemGridWindow;
      ...
      protected var var_229:Boolean = true;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_938,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_305,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_762,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_260,this.deActivateScrollbar);
         }
         this.var_32 = param2;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_222.stop();
            this.var_222.removeEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_222 = null;
         }
         if(this.var_506 != null)
         {
            this.var_506.destroyGridItems();
            this.var_506 = null;
         }
         this.var_1919 = null;
         this.var_238 = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_506 = _window.findChildByName("itemGrid") as IItemGridWindow;
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1919 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_229)
         {
            this.var_222 = new Timer(25);
            this.var_222.addEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_222.start();
         }
         else
         {
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_817 >= 0 && this.var_817 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_817];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         this.var_506.addGridItem(_loc2_);
         ...
         {
            ++this.var_1886;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1886);
         }
      }
