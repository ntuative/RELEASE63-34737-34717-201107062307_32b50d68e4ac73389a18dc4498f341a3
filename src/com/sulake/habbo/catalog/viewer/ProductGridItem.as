package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1121:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_218:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1121).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1121).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_94,MouseCursorType.const_790);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_790);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            this.var_218.select(this);
            this.var_545 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_545 != null && this.var_545 == param2)
         {
            _loc3_ = this.var_218.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_545 = null;
            }
