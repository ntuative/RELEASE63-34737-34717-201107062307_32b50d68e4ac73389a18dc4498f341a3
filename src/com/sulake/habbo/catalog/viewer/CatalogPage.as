package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2055:String = "ctlg_";
       
      
      protected var var_2266:XML;
      ...
      {
         var _loc2_:String = const_2055 + param1;
         ...
         this.var_2266 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2266) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1942:
               if(this.var_1346 == null)
               {
            ...
            case CatalogWidgetEnum.const_1743:
               ...
               break;
            case CatalogWidgetEnum.const_1958:
            ...
            case CatalogWidgetEnum.const_1796:
               ...
               break;
            case CatalogWidgetEnum.const_1764:
