package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         this.var_680 = 0;
         for each(_loc4_ in this.var_174)
         {
            if(_loc4_ > this.var_680)
            {
               this.var_680 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_680).toString().length - 1);
         this.var_680 = Math.ceil(this.var_680 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_680.toString();
         _loc3_.draw(_loc6_);
         this.var_1300 = param1 - _loc6_.textWidth - 2;
         this.var_1048 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_1048);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_1048 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(this.var_1300 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1300,(param2 - this.var_1048) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1300 + this.var_1300 / -this.var_3081 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_1048 - this.var_1048 / this.var_680 * this.var_174[param1];
      }
      
      public function get available() : Boolean
      {
         return this._x && this.var_174 && this._x.length > 1;
      }
   }
}
