package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1111:int = 0;
      ...
      {
         return this.var_684 != const_1111;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1976 != RecyclerStatusMessageEvent.const_1210;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_684 == const_484;
      }
      ...
      {
         this.var_684 = const_1110;
         this.var_134 = new Array(const_234);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_234)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_684 = const_1111;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1976)
         {
            case RecyclerStatusMessageEvent.const_1998:
               this.var_684 = const_484;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1210:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1785:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1402:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1857:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_134[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_234)
            {
               oldObjectData = this.var_134[newSlotId];
         ...
         this.var_134[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_134[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_134[param1].id))
         {
            return;
         }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_134.length < const_234)
         {
            return false;
         }
         var _loc1_:int = 0;
