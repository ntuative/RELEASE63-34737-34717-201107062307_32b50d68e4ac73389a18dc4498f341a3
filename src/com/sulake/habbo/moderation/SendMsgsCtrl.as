package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         return WindowTracker.const_1736;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.messageTemplates[this.var_1174.selection];
         if(_loc3_ != null)
         {
            this.var_705 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModMessageMessageComposer(this.var_1465,this.var_528.text,this.var_1464));
         this.dispose();
      }
