package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1102:Array = [];
      
      private static var var_2088:int = 1000;
      
      private static var var_1103:Array = [];
      
      private static var var_2089:int = 200;
      ...
      private var var_2091:IMessageComposer;
      ...
      {
         this.var_893 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_892 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         ...
         this.var_35.connection.send(this.var_2091);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1102.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_892.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1102.length < var_2088)
         {
            ...
            param1.width = this.var_892.width;
            param1.height = this.var_892.height;
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1103.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_893.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1103.length < var_2089)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_893.width;
            param1.height = this.var_893.height;
            var_1103.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2090[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1639.getValue(param2.chatterName))
            {
               this.var_1639.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1639.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1640)
         {
