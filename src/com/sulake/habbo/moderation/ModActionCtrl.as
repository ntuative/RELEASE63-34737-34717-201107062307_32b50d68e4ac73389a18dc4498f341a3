package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_967:OffenceCategoryData;
      
      private var var_966:OffenceData;
      
      private var var_1182:IButtonWindow;
      
      private var var_1184:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1182 = IButtonWindow(this.var_35.getXmlWindow("modact_offence"));
         this.var_1184 = IButtonWindow(this.var_35.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this.var_1183 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1183);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_967 != null;
         ...
         else if(this.var_967 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_967.offences,this.var_1182,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_35.initMsg.offenceCategories,this.var_1184,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1465,this.var_528.text,this.var_1464));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_967 = this.var_35.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_966 = this.var_967.offences[_loc3_];
         this.var_528.text = this.var_966.msg;
         this.var_705 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1465,this.var_528.text,this.var_1464));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1183.selection < 0)
         {
            this.var_35.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1465,this.var_528.text,this.getBanLength(),this.var_1464));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1183.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1182.destroy();
            this.var_1182 = null;
         }
         if(this.var_1184 != null)
         {
            this.var_1184.destroy();
            this.var_1184 = null;
         }
         this.var_1183 = null;
         this.var_528 = null;
