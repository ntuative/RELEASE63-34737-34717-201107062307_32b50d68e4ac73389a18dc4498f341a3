package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2364:String = "open_issues";
      
      private const const_2362:String = "picked_issues";
      ...
      private var var_405:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_300 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_300.numTabItems)
            {
               _loc5_ = this.var_300.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_48,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_300 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_300 == null || this.var_300.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_300.selector.getSelectableByName("open_issues");
         this.var_300.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_405 == _loc2_)
         {
            return;
         }
         if(this.var_405 != null)
         {
            this.var_405.visible = false;
         }
         this.var_405 = _loc2_;
         if(this.var_405 == null)
         {
         ...
         this.var_405.view.width = this.var_300.container.width;
         this.var_405.view.height = this.var_300.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2363:
               ...
               {
                  this.var_2046 = new MyIssuesView(this.issueManager,this,this.var_300.container);
               }
               return this.var_2046;
            case this.const_2364:
               if(this.var_2044 == null)
               {
                  this.var_2044 = new OpenIssuesView(this.issueManager,this,this.var_300.container);
               }
               return this.var_2044;
            case this.const_2362:
               if(this.var_2045 == null)
               {
                  this.var_2045 = new PickedIssuesView(this.issueManager,this,this.var_300.container);
               }
