package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_759:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2281 = param2.pickerUserId;
         this.var_2282 = param2.pickerUserName;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1157 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1156;
         }
         if(this.var_758 == null || param1.timeStamp < this.var_758.timeStamp)
         {
            this.var_758 = param1;
         }
         if(this.var_759 == null || param1.priority > this.var_759.timeStamp)
         {
            this.var_759 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_759;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_758;
         if(_loc2_ == null)
         {
