package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_449.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_449)
         {
            this.var_449.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_449.reset();
            this.var_449 = null;
         }
         if(this.var_383)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_59 == null)
         {
            this.var_59 = IWindowContainer(this._navigator.getXmlWindow(this.var_1151));
            this.var_59.visible = false;
            this.var_59.setParamFlag(HabboWindowParam.const_46,true);
         ...
         this.var_59.x = _loc2_.x + this.var_2419 + param1.width;
