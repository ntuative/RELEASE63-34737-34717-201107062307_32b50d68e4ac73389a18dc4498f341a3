package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2084:IButtonWindow;
      
      private var var_2085:IButtonWindow;
      
      private var var_2086:IButtonWindow;
      
      private var var_2859:IWindowContainer;
      
      private var var_2858:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_2084 = IButtonWindow(this.find("bg_tab"));
         this.var_2085 = IButtonWindow(this.find("top_tab"));
         this.var_2086 = IButtonWindow(this.find("obj_tab"));
         this.var_2859 = IWindowContainer(this.find("tile_grid"));
         this.var_2858 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_2084,this.onBgTabButton);
         Util.setProcDirectly(this.var_2085,this.onTopTabButton);
         Util.setProcDirectly(this.var_2086,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_2084,this.var_78.mode != ThumbnailEditorModel.const_39);
         this.setEnabled(this.var_2085,this.var_78.mode != ThumbnailEditorModel.const_64);
         this.setEnabled(this.var_2086,this.var_78.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2858;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2859;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_605)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_72,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_352,HabboWindowStyle.const_47,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_368,HabboWindowStyle.const_47,HabboWindowParam.const_63,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
