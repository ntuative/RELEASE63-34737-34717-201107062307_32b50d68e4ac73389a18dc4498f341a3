package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1005:TextFieldManager;
      ...
      private var var_812:ICheckBoxWindow;
      
      private var var_1875:ITextWindow;
      
      private var var_1007:IDropMenuWindow;
      
      private var var_1006:IDropMenuWindow;
      ...
      private var var_1525:IWindowContainer;
      ...
      {
         if(param1 != this.var_385 || this.var_1246 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1246 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1887)
         {
            this.var_813.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1843)
         {
            this.var_813.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1930)
         {
            this.var_1245.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1755)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1980)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1771)
         {
            this.var_1005.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_813.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_366,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_643,this.onDoorModePasswordUnselect);
         ...
         this.var_813 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1245 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_973 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_974 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1005 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1239 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1240 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1243 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1242 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_812 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1875 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_1007 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_1006 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2552 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1241 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1244 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1876 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1525 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_248 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1247 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1524 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1524.mouseThreshold = 0;
         this.var_1524.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1247.visible = false;
         if(!this.var_1523)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1876.visible = this.var_1523;
         this.populateForm();
         if(this.var_811)
         {
            ...
            this.var_1244.height = Util.getLowestPoint(this.var_1244) + 4;
         }
         else
         {
            this.var_1241.visible = true;
            this.var_1525.visible = true;
            this.var_2552.visible = this.var_1523;
            this.var_1241.height = Util.getLowestPoint(this.var_1241) + 4;
         }
         this.var_1524.text = !!this.var_811 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1241.name,this.var_1244.name,this.var_1525.name,this.var_1876.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_813.setText(_loc1_.name);
         this.var_1245.setText(_loc1_.description);
         this.var_1005.setText("");
         this.var_1239.setText("");
         ...
         this.setTag(this.var_973,_loc1_.tags[0]);
         this.setTag(this.var_974,_loc1_.tags[1]);
         if(this.var_1240)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1242)
         {
            ...
            {
               this.var_1242.select();
            }
            else
            {
               this.var_1242.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_812);
            this.disableWindow(this.var_1007);
            this.disableWindow(this.var_1006);
            this.disableWindow(this.var_1875);
         }
         else
         {
            this.enableWindow(this.var_812);
            this.enableWindow(this.var_1007);
            this.enableWindow(this.var_1006);
            this.enableWindow(this.var_1875);
         }
         if(this.var_812)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_812.unselect();
            }
         }
         if(this.var_1007)
         {
            this.var_1007.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_1006)
         {
            this.var_1006.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_813.getText();
         _loc2_.description = this.var_1245.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_638;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_121)
         {
            _loc8_ = this.var_1005.getText();
            _loc9_ = this.var_1239.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1005.clearErrors();
               this.var_1239.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = this.var_1243.isSelected;
         _loc2_.allowWalkThrough = this.var_1242.isSelected;
         _loc2_.hideWalls = this.var_812.isSelected;
         _loc2_.wallThickness = this.var_1007.selection - 2;
         _loc2_.floorThickness = this.var_1006.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_973,_loc2_.tags);
         this.addTag(this.var_974,_loc2_.tags);
         this.clearErrors();
         this.var_1246 = _loc2_.roomId;
      ...
      private function refreshFlatControllers() : void
      {
         ...
         var _loc1_:IWindow = this.var_248.findChildByName("ruler");
         if(_loc1_ != null)
         {
            _loc1_.visible = true;
         }
         var _loc2_:IWindow = this.var_248.findChildByName("flat_ctrls_caption_txt");
         if(_loc2_ != null)
         {
            this._navigator.registerParameter("navigator.roomsettings.flatctrls.caption","cnt","" + this.var_56.controllerCount);
            _loc2_.visible = true;
         }
         var _loc3_:IWindowContainer = IWindowContainer(this.var_248.findChildByName("flat_controller_list"));
         if(_loc3_ != null)
         {
            ...
            _loc5_ = this.var_248.findChildByName("flat_ctrls_info_txt");
            _loc6_ = this.var_248.findChildByName("flat_ctrls_limit_txt");
            _loc7_ = IWindowContainer(this.var_248.findChildByName("flat_controllers_footer"));
            if(this.var_56 != null && this.var_56.controllers.length > 0)
            {
               ...
               Util.moveChildrenToColumn(this.var_248,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc2_.y,5);
            }
            else
            {
         ...
         var _loc4_:IButtonWindow = IButtonWindow(this.var_248.findChildByName("remove_flat_ctrl"));
         if(_loc4_ != null)
         {
            if(_loc8_)
            {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_72,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,20)));
      }
