package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2360 = new RoomThumbnailRenderer(param1);
         this.var_952 = new TagRenderer(param1,hideInstantly);
      }
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_952.refreshTags(_loc1_,this.var_139.tags);
         ...
         this.var_2360.refreshThumbnail(_loc1_,this.var_139.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_287,Tabs.const_423,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
