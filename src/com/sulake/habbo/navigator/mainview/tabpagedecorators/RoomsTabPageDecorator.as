package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_159 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_205,Tabs.const_436);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_205,Tabs.const_946);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_205,Tabs.const_436,"" + _loc3_);
         }
         if(this.var_159)
         {
            this._navigator.trackNavigationDataPoint(this.var_159.enumerateSelection()[this.var_159.selection],"category.view");
         }
      }
