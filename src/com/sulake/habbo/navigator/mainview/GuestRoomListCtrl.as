package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_539:RoomPopupCtrl;
      
      private var var_606:IScrollbarWindow;
      
      private var var_1224:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_539 = new RoomPopupCtrl(this._navigator,5,-5);
         this.var_1224 = new UserCountRenderer(this._navigator);
      }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_606 = IScrollbarWindow(this.var_198.findChildByName("scroller"));
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_192,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1792,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this.var_1224.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_539.visible && this.var_2481)
         {
            return;
         }
         ...
         this.var_539.room = _loc4_;
         this.var_539.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1508.tags[0];
            this.var_1508.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2480 - _loc2_.stageX);
         this.var_2480 = _loc2_.stageX;
         this.var_2481 = _loc3_ > 2;
      }
   }
}
