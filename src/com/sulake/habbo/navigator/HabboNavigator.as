package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_321:MainViewCtrl;
      
      private var var_626:RoomInfoViewCtrl;
      
      private var var_1188:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_488:Tabs;
      ...
      private var var_2360:RoomThumbnailRenderer;
      
      private var var_1005:GuestRoomPasswordInput;
      
      private var var_342:GuestRoomDoorbell;
      
      private var var_1189:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2359 = new Array();
         ...
         this.var_321 = new MainViewCtrl(this);
         this.var_626 = new RoomInfoViewCtrl(this);
         this.var_1188 = new RoomCreateViewCtrl(this);
         this.var_2360 = new RoomThumbnailRenderer(this);
         this.var_1005 = new GuestRoomPasswordInput(this);
         this.var_342 = new GuestRoomDoorbell(this);
         this.var_488 = new Tabs(this);
         this.var_1189 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_368,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_321.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_142.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_321.startSearch(Tabs.const_287,Tabs.const_503,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_321.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_321.startSearch(Tabs.const_293,Tabs.const_264);
         this.var_488.getTab(Tabs.const_293).tabPageDecorator.tabSelected();
      }
