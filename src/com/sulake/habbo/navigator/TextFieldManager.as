package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_69.addEventListener(WindowKeyboardEvent.const_196,this.checkEnterPress);
         this.var_69.addEventListener(WindowEvent.const_108,this.checkMaxLen);
         this._orgTextBackground = this.var_69.textBackground;
         this.var_2828 = this.var_69.textBackgroundColor;
      ...
      public function restoreBackground() : void
      {
         ...
         this.var_69.textBackgroundColor = this.var_2828;
      ...
      {
         return !this.var_705 && Util.trim(this.getText()).length > 2;
      }
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_69.text = this.var_2829;
         this.var_705 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:WindowEvent) : void
      {
         ...
         if(_loc2_.length > this.var_2063)
         {
            this.var_69.text = _loc2_.substring(0,this.var_2063);
         }
      }
   }
}
