package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_199:String = "face";
      ...
      private var var_2525:FriendListLookAndFeel;
      
      private var var_488:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1859:OpenedToWebPopup;
      ...
      private var var_1860:AvatarSearchResults;
      ...
      {
         this.var_2525 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_118 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1860 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(this.var_1859 == null)
         {
            this.var_1859 = new OpenedToWebPopup(this);
         }
         this.var_1859.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_114);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_396);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_368,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_603.createAvatarImage(param1,AvatarScaleType.const_113,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_142.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_142.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_1033 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_1396,this.getText("friendlist.friends")));
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_432,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_118.addFriend(new Friend(_loc4_));
         }
         this.var_488 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_649)
         {
         ...
         {
            _loc5_ = this.var_118.findCategory(FriendCategory.const_432);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_488.findTab(FriendListTab.const_91).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_488.findTab(FriendListTab.const_91);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1860.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_488.findTab(FriendListTab.const_91);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_488.findTab(FriendListTab.const_91);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_806 || !this.var_121)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_806.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_121.vipLimit;
         }
         else if(this.var_806.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_199) as IBitmapWrapperWindow;
