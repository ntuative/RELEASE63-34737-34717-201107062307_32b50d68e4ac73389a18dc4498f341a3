package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1545:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2185:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2185 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1545;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1047 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_303 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_2185.prepare(this.var_1047);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1360,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1371,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_967,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_782,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_967,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_782,true);
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2187 == -1 ? 0 : int(this.var_16.height - this.var_2187);
         var _loc4_:int = this.var_2186 == -1 ? 0 : int(this.var_16.width - this.var_2186);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_303.y = Util.getLowestPoint(this.var_16.content);
         this.var_303.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1382,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_967,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1360,false);
         ...
         this.var_2187 = this.var_16.height;
         this.var_2186 = this.var_16.width;
