package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2085:String = "no_reqs_info";
      ...
      private var var_1974:IContainerButtonWindow;
      
      private var var_1975:IContainerButtonWindow;
      ...
      {
         this.var_1974 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1975 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1975.procedure = this.onDismissAllButtonClick;
         this.var_1974.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_403)
         {
         ...
         else if(param1.state == FriendRequest.const_1195)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_403;
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_403 && _loc2_.state != FriendRequest.const_407)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1974,_loc1_);
         this.setEnabled(this.var_1975,_loc1_);
      }
