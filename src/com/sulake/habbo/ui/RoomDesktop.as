package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private static const const_1442:int = 1000;
      ...
      private var var_1160:IRoomWidgetFactory = null;
      
      private var var_418:ISessionDataManager = null;
      
      private var var_15:IRoomSessionManager = null;
      
      private var var_1012:IAvatarRenderManager = null;
      ...
      private var var_1253:IHabboHelp = null;
      ...
      private var var_2300:uint = 16777215;
      ...
      private var var_1720:Rectangle;
      ...
      public function set navigator(param1:IHabboNavigator) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_332,this.onNavigatorEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this._navigator.events.removeEventListener(HabboNavigatorEvent.const_332,this.onNavigatorEvent);
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_32 != null)
         {
            this.var_763 = this._roomEngine.loadRoomResources(this.var_32.roomResources);
      ...
      {
         if(this.var_330 != null && this.var_32.state == RoomSessionEvent.const_279)
         {
            this.var_1721 = !this.var_330.showInterstitial();
         }
      ...
      {
         if(this.var_763 == null || this.var_763.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_763.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_763.splice(_loc2_,1);
         }
         if(this.var_763.length == 0)
         {
            this.var_1718 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc8_ = this.var_761.getValue(_loc11_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_761.add(_loc11_,_loc8_);
                  }
                  else
                  {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc8_ = this.var_762.getValue(_loc12_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_762.add(_loc12_,_loc8_);
                  }
                  _loc8_.push(_loc4_);
               }
            }
         }
         _loc2_ = this.var_1160.createWidget(param1,_loc4_);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_loc4_.getNumber(RoomObjectVariableEnum.const_1191) == 1)
               {
                  _loc2_ = true;
                  if(this.var_418.isAnyRoomController)
                  {
                     _loc2_ = false;
                  }
               }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineObjectEvent.const_444:
               ...
               break;
            case RoomEngineObjectEvent.const_517:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_165,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            ...
            case RoomEngineObjectEvent.const_194:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_435,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_876:
               if(!this.var_32.isRoomController && !this.var_418.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_140:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1014,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_158:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1237,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.const_556:
            ...
            case RoomEngineObjectEvent.const_152:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_928,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_604:
            ...
            case RoomEngineEvent.const_666:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_450,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_32.roomId,this.var_32.roomCategory,RoomVariableEnum.const_822);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_32.roomId,this.var_32.roomCategory,RoomVariableEnum.const_752);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_32.roomId,this.var_32.roomCategory,RoomVariableEnum.const_812);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_32.roomId,this.var_32.roomCategory,RoomVariableEnum.const_852);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_312,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2300);
      ...
      public function canvasMouseHandler(param1:WindowEvent) : void
      {
         ...
         switch(_loc2_.type)
         {
            ...
            case WindowMouseEvent.const_312:
               _loc3_ = "null";
               break;
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_1720));
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1719) / 1000);
            if(this._habboTracking != null)
            {
               if(param1)
               {
                  this._habboTracking.trackGoogle("zoomEnded","IAvatarRenderManager",_loc3_);
               }
               else
               {
      ...
      {
         var _loc2_:* = null;
         if(param1.type == HabboNavigatorEvent.const_332)
         {
            if(this.var_32 != null)
            {
               _loc2_ = this._roomEngine.getRoomCanvasGeometry(this.var_32.roomId,this.var_32.roomCategory,this.getFirstCanvasId());
      ...
      {
         if(this.var_15 != null && this.var_32 != null && this.var_1721 && this.var_1718)
         {
            this.var_15.startSession(this.var_32);
            this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_329));
            return true;
         }
         return false;
      }
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_505:
               ...
               this.var_241 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_451,WindowStyle.const_104,WindowParam.const_101) as IToolTipWindow;
               this.var_241.setParamFlag(WindowParam.const_31,false);
