package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1460:int = 162;
      
      private static const const_1465:int = 16;
      
      private static const const_686:int = 4;
      
      private static const const_1471:uint = 14342874;
      
      private static const const_1472:uint = 3815994;
      
      private static const const_1469:uint = 2085362;
      
      private static const const_1464:uint = 39616;
      
      private static const const_1462:uint = 10513106;
      
      private static const const_1470:uint = 8734654;
      
      private static const const_1466:uint = 9094430;
      
      private static const const_1463:uint = 6200576;
      
      private static const const_1459:String = "happiness";
      
      private static const const_1461:String = "experience";
      
      private static const const_1468:String = "energy";
      
      private static const const_1467:int = 250;
      
      private static const const_1050:int = 25;
      
      private static const const_1049:int = 5;
      ...
      private var var_211:PetCommandTool;
      ...
      {
         if(this.var_55 == null || this.var_47 == null || this.var_108 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_47.width,this.var_108.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_47.width < this.var_108.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1459,param1.nutrition,param1.nutritionMax,const_1464,const_1469);
         this.updateStateElement(const_1461,param1.experience,param1.experienceMax,const_1470,const_1462);
         this.updateStateElement(const_1468,param1.energy,param1.energyMax,const_1463,const_1466);
         ...
         this.updateWindow();
         this.var_551 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_211 && this.var_211.isVisible() && param1.isOwnPet)
         {
            this.var_211.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_211.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1460,const_1465,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1471);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1472);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_686,_loc7_.width - 2,_loc7_.height - 2 - const_686);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_686);
      ...
      private function openTrainView() : void
      {
         if(this.var_211 == null)
         {
            this.var_211 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_551) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_211.showWindow(true);
            this.var_211.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_211 && this.var_211.getPetId() == this.var_551)
               {
                  this.var_211.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1955,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_422,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1050 + const_1049;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1049;
            }
         }
         this.var_108.height = _loc4_ + const_1050;
         this.updateWindow();
      }
   }
}
