package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_456)
         {
            this.var_1766 = param1.songId;
         }
         if(param1.songId == this.var_1766)
         {
            this._songName = param1.songName;
            this.var_2802 = param1.songAuthor;
            this.updateNowPlaying(this.var_1766 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2802;
         }
         else
         {
