package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1032:uint = 2;
      
      protected static var var_1431:uint = const_1033;
      
      private static const const_1556:uint = 16744755;
      
      private static const const_1557:uint = 16756591;
      
      private static const const_1076:int = 8;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_661:uint = 1;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1704)
         {
            ...
            {
               this.var_661 = const_1032;
            }
            else
            {
               this.var_661 = var_1431;
            }
         }
         if(this.var_661 == const_1033)
         {
      ...
      private function showButton(param1:String, param2:Boolean = true) : void
      {
         ...
         if(_loc6_)
         {
            ...
            {
               _loc6_.x = _loc5_.x + (_loc5_.width - _loc5_.textWidth) / 2 - _loc6_.width - const_1076;
            }
            if(_loc6_.tags.indexOf("arrow_right") != -1)
            {
               _loc6_.x = _loc5_.x + (_loc5_.width + _loc5_.textWidth) / 2 + const_1076;
            }
         }
      }
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = param2.tags.indexOf("moderate") > -1 ? uint(const_2048) : uint(const_1036);
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1557;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1556;
               }
            }
         }
         if(_loc3_)
