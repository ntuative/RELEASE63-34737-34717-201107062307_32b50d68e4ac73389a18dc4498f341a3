package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1051:String = "use_minimized_own_avatar_menu";
      ...
      private var var_775:AvatarInfoView;
      
      private var var_776:OwnAvatarMenuView;
      
      private var var_777:AvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_2322 = Boolean(this.var_142.getBoolean("menu.avatar.enabled",false));
         this.var_1735 = this.var_142.getBoolean("menu.own_avatar.enabled",false);
         ...
         this.handler.container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_301,this.onEffectsChanged);
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_834,0,0));
      }
      ...
      override public function dispose() : void
      {
         ...
         this.handler.container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_301,this.onEffectsChanged);
         this._view = null;
         this.var_142 = null;
         super.dispose();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetAvatarInfoEvent.const_124,this.method_1);
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_334,this.method_1);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_165,this.method_1);
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_382,this.method_1);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.BOT,this.method_1);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.const_117,this.method_1);
         param1.addEventListener(RoomWidgetUserDataUpdateEvent.const_128,this.method_1);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_200,this.method_1);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_99,this.method_1);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_450,this.method_1);
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_672,this.method_1);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_1008,this.method_1);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_435,this.method_1);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetAvatarInfoEvent.const_124,this.method_1);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_334,this.method_1);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_165,this.method_1);
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_382,this.method_1);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.BOT,this.method_1);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.const_117,this.method_1);
         param1.removeEventListener(RoomWidgetUserDataUpdateEvent.const_128,this.method_1);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_200,this.method_1);
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_99,this.method_1);
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_450,this.method_1);
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_672,this.method_1);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_435,this.method_1);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_435,this.method_1);
      }
      ...
      private function method_1(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_124:
               ...
               if(this.var_1735 && _loc2_.allowNameChange)
               {
            ...
            case RoomWidgetRoomObjectNameEvent.const_672:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_334:
               this.var_1736 = true;
               break;
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_1008:
               ...
               {
                  this.var_1733 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_775,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_435:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_1733)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_157:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_125,false,!!_loc3_.isSpectatorMode ? null : this.var_242);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_507,false,null);
               break;
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_200:
               ...
               for each(_loc7_ in this.var_373)
               {
            ...
            case RoomWidgetRoomEngineUpdateEvent.const_99:
               this.var_1734 = false;
               break;
            case RoomWidgetRoomEngineUpdateEvent.const_450:
               this.var_1734 = true;
         }
      ...
      public function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_344,_loc2_.id,RoomObjectCategoryEnum.const_29);
      ...
      private function storeUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.var_242.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_116;
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_1735) : Boolean(this.var_2322);
         }
            ...
            if(!this.var_1734)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_776)
                     {
                        this.var_776 = new OwnAvatarMenuView(this);
                     }
                     this._view = this.var_776;
               ...
               else
               {
                  if(!this.var_775)
                  {
                     this.var_775 = new AvatarInfoView(this);
                  }
                  this._view = this.var_775;
      ...
      public function removeView(param1:AvatarInfoView, param2:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_373.remove(param1.userName);
               param1.dispose();
               this.checkUpdateNeed();
            }
         }
      ...
      public function checkUpdateNeed() : void
      {
         ...
         if(this._view || this.var_373.length > 0)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         for each(_loc3_ in this.var_373)
         {
      ...
      {
         this.handler.container.avatarEditor.openEditor(AvatarEditorInstanceId.const_215,null,null,true);
         this.handler.container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_215);
      }
      ...
      {
         return this.handler.container.config.getBoolean(const_1051,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1051,!!param1 ? "1" : "0");
      }
   }
}
