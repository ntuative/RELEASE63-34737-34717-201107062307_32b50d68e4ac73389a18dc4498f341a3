package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_851:String = "MISV_BUY_MORE";
      
      public static const const_887:String = "MISV_PREVIEW_PLAYING";
      ...
      {
         if(this.var_2120 == null)
         {
            return;
         }
         this.var_2120.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_887,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_851,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_486.add(const_887,_loc1_);
            this.var_2121 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2120 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_646));
         ...
         if(_loc1_ != null)
         {
            this.var_486.add(const_851,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_628));
         }
      }
