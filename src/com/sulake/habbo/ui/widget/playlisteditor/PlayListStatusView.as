package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_996:String = "PLSV_ADD_SONGS";
      
      public static const const_1190:String = "PLSV_START_PLAYBACK";
      
      public static const const_619:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_54 != const_619)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_486[this.var_54];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_486[const_996];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_486.add(const_619,_loc1_);
