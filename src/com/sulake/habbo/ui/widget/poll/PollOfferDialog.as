package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1835:String = "POLL_OFFER_STATE_OK";
      
      public static const const_862:String = "POLL_OFFER_STATE_CANCEL";
      ...
      private function onOk(param1:WindowEvent) : void
      {
         ...
         this._state = const_1835;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_807,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._state = const_862;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_612,this._id));
