package com.sulake.habbo.ui.widget.notification
{
   ...
   public class UserNotificationView implements IDisposable
   {
      ...
      protected static const const_2041:String = "button_ok";
      
      protected static const const_2040:String = "text_title";
      
      protected static const DESCRIPTION_NAME:String = "text_description";
      
      protected static const const_2337:String = "widget_notification_frame";
      ...
      public function showNotification(param1:String, param2:String) : Boolean
      {
         ...
         dialog.center();
         dialog.findChildByName(const_2041).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,function(param1:WindowMouseEvent):void
         {
