package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_1045:String = "welcome_gift_email_verified";
      
      private const const_1438:String = "welcome_gift_email_change";
      
      private const const_2342:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1158)
         {
            this.setViewState(this.const_1045);
         }
         else
         {
      ...
      {
         this.setViewState(this.const_1438);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_875,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1158 ? this.const_1045 : this.const_684);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1437 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1437));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_662,this.method_1);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_1009,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_662,this.method_1);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_1009,this.emailChangeHandler);
      }
      ...
      private function method_1(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_662:
               this.var_1438 = param1.email;
               this.var_1158 = param1.isVerified;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1438 = this.var_1437;
            this.setViewState(this.const_684);
         }
         else
         {
            if(param1.result == this.const_2342)
            {
               this.var_943 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1437);
