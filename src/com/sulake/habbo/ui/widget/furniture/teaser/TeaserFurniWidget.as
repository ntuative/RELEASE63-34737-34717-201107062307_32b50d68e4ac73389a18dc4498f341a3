package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2095:int = 1;
      ...
      private const const_2367:int = 1;
      
      private const const_2372:int = 2;
      
      private const const_2369:int = 3;
      
      private const const_2371:int = 4;
      
      private const const_2373:int = 5;
      
      private const const_2089:String = "deco_img";
      
      private const const_2090:String = "dialog_bg";
      
      private const const_2368:String = "%campaign%_dialog_bg.png";
      
      private const const_390:String = "%campaign%_gift_package.png";
      
      private const const_2375:String = "%campaign%_gift_content.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1626 = this.var_151.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1626 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1624.length)
         {
            _loc2_ = this.var_1624.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_151 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_756,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_759,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_615,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_615:
               ...
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_759:
               ...
               this._shareId = null;
               this.var_1625 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_756:
               _loc2_ = this.const_2095;
               this.var_237 = param1.objectId;
               this._shareId = param1.data;
               this.var_431 = param1.status;
               this.var_1625 = param1.itemCategory;
         ...
         if(this._window && (this.var_1623 != _loc2_ || _loc3_ != this.var_205))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1623)
            {
               ...
               case this.const_2095:
                  ...
                  else if(this.var_431 == this.const_2373)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_205,"client.show.campaign_closed");
            ...
            _loc5_ = this.const_2368.replace("%campaign%",this.var_205);
            this.setDecoImage(_loc5_,this.const_2090);
            _loc2_ = _loc2_.replace("%campaign%",this.var_205);
            this.setDecoImage(_loc2_,this.const_2089);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_769);
      ...
      {
         this.sendConversionPoint("viral_" + this.var_205,"client.skip_post");
         this.hideInterface();
      }
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         this.sendConversionPoint("viral_" + this.var_205,"client.start_post",this._shareId);
         var _loc4_:String = this.var_151.getKey("viral.furni.post_type","feed");
         HabboWebTools.facebookViralGiftPost(this.var_205,_loc2_,_loc3_,this._shareId,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_12)
         {
            if(this.var_1625 != 0)
            {
               this.var_12.toggleInventoryPage(this.var_1625 == 1 ? "null" : InventoryCategory.const_136);
            }
         }
         this.sendConversionPoint("viral_" + this.var_205,"client.open_gift");
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_986,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1624.push(new ImageDownloader(this,_assets,this.var_205,this.var_1626,param1,param2));
            return;
         }
         var _loc5_:BitmapData = (_loc4_.content as BitmapData).clone();
         switch(param2)
         {
            case this.const_2090:
            case this.const_2089:
      ...
      function onDecoImageReady(param1:ImageDownloader) : void
      {
         ...
         if(!this._window || this.var_205 != param1.campaignID)
         {
            return;
         }
