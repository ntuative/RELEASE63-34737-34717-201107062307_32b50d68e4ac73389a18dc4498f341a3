      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_457:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_77,this.var_151,this.var_2857++,this);
               break;
            case RoomWidgetEnum.const_335:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_77,this.var_151,this);
               break;
            case RoomWidgetEnum.const_618:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_77,this.var_151,this._catalog);
               break;
            case RoomWidgetEnum.const_563:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_77,events,this.var_151);
               break;
            ...
            case RoomWidgetEnum.const_587:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_77,this.var_151,this.var_12);
               break;
            ...
            case RoomWidgetEnum.const_513:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_77,this.var_151);
               break;
            case RoomWidgetEnum.const_569:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_77,this.var_151);
               break;
            case RoomWidgetEnum.const_139:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_77,this.var_151);
               break;
            ...
            case RoomWidgetEnum.const_124:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_151,this.var_77,this);
               break;
            ...
            case RoomWidgetEnum.const_611:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_77,this.var_151,this._catalog);
               break;
