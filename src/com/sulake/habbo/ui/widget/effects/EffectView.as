package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private var var_145:IWidgetAvatarEffect;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_145 = param2;
         this._widget = param1;
         this.var_222 = new Timer(this.const_2381);
         this.var_222.addEventListener(TimerEvent.TIMER,this.onUpdate);
         this.update();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_222.stop();
            this.var_222.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_222 = null;
         }
         this._widget = null;
         this.var_145 = null;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_145.isActive)
         {
            _loc2_ = this.var_145.secondsLeft / Number(this.var_145.duration);
            this.var_743.width = _loc2_ * this.var_336;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_599 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_599 == null)
            {
               return;
            }
         ...
         if(!this.var_145.isActive)
         {
            this.var_599.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_599.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_599.text;
         var _loc2_:int = this.var_145.secondsLeft;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_72,HabboWindowStyle.const_30,HabboWindowParam.const_63) as IWindowContainer;
         }
         ...
         this.var_599 = null;
         var _loc2_:String = "";
         if(this.var_145.isInUse)
         {
            _loc2_ = "memenu_effect_selected";
         }
         else if(this.var_145.isActive)
         {
         ...
         if(this.var_743 != null)
         {
            this.var_336 = this.var_743.width;
            this.var_222.start();
            this.onUpdate();
         }
         if(this.var_145.icon)
         {
            this.setElementBitmap("effect_icon",this.var_145.icon);
         }
      ...
      private function onMouseEvent(param1:WindowMouseEvent) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               this._widget.selectEffect(this.var_145.type,this.var_145.isInUse);
         }
      }
