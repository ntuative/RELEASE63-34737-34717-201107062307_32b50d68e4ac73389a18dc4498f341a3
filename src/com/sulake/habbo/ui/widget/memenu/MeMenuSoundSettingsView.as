package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_956:MeMenuSoundSettingsSlider;
      
      private var var_960:BitmapData;
      
      private var var_958:BitmapData;
      ...
      {
         this.var_961 = param1.volume;
         if(this.var_956 != null)
         {
            this.var_956.setValue(this.var_961);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_960 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_958 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_959 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_957 = (_loc5_.content as BitmapData).clone();
         }
         this.var_956 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_992));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_961 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_957);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_960);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_959);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_958);
         }
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               this._widget.changeView(MeMenuWidget.const_742);
               break;
            default:
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_1015);
         }
