   ...
   public class FurniChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         while(_loc4_ < _loc9_)
         {
            ...
            if(_loc8_ != null)
            {
               _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_273);
         ...
         while(_loc4_ < _loc9_)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_273);
                  _loc6_ = this._container.sessionDataManager.method_4(_loc5_);
         ...
         this._container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_806,_loc3_,this._container.sessionDataManager.isAnyRoomController));
      }
