package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(InterstitialEvent.const_526);
         _loc1_.push(InterstitialEvent.const_641);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_109);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_329);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_526:
               ...
               break;
            case InterstitialEvent.const_641:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_109:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_329:
               this._container.events.dispatchEvent(param1);
         }
      }
