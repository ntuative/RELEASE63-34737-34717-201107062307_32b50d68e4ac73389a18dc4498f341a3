package com.sulake.habbo.ui.handler
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1529:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_976,RoomWidgetPresentOpenMessage.const_195];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_976:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = _loc5_.getNumber(RoomObjectVariableEnum.const_273);
            ...
            case RoomWidgetPresentOpenMessage.const_195:
               ...
               if(_loc4_.objectId != this.var_237)
               {
                  return null;
               }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_383:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        _loc3_ = this._container.sessionDataManager.method_4(_loc2_.classId);
                     }
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_65:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_622,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_675,0,this._container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1529)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_353:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_554,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
