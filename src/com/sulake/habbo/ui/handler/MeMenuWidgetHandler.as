package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private var var_1917:BitmapData;
      
      private var var_1916:BitmapData;
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_215);
         }
         this.var_1147 = true;
         this.container = null;
         this.var_12 = null;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this.var_12.events.removeEventListener(HabboInventoryEffectsEvent.const_301,this.onAvatarEffectsChanged);
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_375,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.catalog.events.removeEventListener(PurseEvent.const_131,this.onCreditBalance);
            }
         }
         ...
         if(this.var_12 != null)
         {
            this.var_12.events.addEventListener(HabboInventoryEffectsEvent.const_301,this.onAvatarEffectsChanged);
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_375,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.catalog.events.addEventListener(PurseEvent.const_131,this.onCreditBalance);
         }
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1552)
            {
               ...
               this.var_1917 = _loc1_;
               this.var_1916 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1917;
               _loc2_ = this.var_1916;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_480)
               {
                  ...
                  if(_loc2_.height > const_480 - const_1094)
                  {
                     _loc8_.offset(0,_loc2_.height - const_480 + const_1094);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_873);
         _loc1_.push(RoomWidgetDanceMessage.const_882);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_826);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1381);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1286);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1284);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_877);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_1028);
         _loc1_.push(RoomWidgetStopEffectMessage.const_995);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1988);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1400);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_540);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1909);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1263);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_849);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_808);
         _loc1_.push(RoomWidgetMeMenuMessage.const_924);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_992);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1982);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_803);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1015);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1351);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_449);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_808:
               ...
               break;
            case RoomWidgetWaveMessage.const_873:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_882:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_826:
               if(this.var_12 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_1286:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_1028:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1404)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_141,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_877:
               ...
               if(this.var_12 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_2032:
                        this._catalog.openCatalogPage(CatalogPageName.const_1196,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1180:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_220);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_2036:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_77);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_2031:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1284:
            case RoomWidgetStopEffectMessage.const_995:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1400:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_849:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_924:
               ...
               {
                  this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_131,this._catalog.getPurse().credits));
               }
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_540:
               Logger.log("MeMenuWidgetHandler: Open avatar editor...");
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_215,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_215);
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_992:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_421,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_803:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_421,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_1015:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_421,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1351:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_583));
               }
               break;
            default:
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_131,param1.balance));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_828:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_527));
         }
      }
