package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.WIDGET_MESSAGE_REQUEST_ECOTRONBOX_WIDGET,RoomWidgetEcotronBoxOpenMessage.const_969,RoomWidgetEcotronBoxOpenedMessage.const_1859];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.WIDGET_MESSAGE_REQUEST_ECOTRONBOX_WIDGET:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_969:
               ...
               case RoomSessionPresentEvent.const_383:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     else if(_loc2_.itemType == "i")
                     {
                        ...
                        _loc4_ = this._container.sessionDataManager.method_4(_loc2_.classId);
                     }
                     if(_loc4_ != null)
                     {
