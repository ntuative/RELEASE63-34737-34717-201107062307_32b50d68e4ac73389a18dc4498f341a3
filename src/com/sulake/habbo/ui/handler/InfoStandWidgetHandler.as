package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_251.events.addEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
            this.var_251.events.addEventListener(SongInfoReceivedEvent.const_96,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_184,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_204,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_188,this.onFigureUpdate);
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_117,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_184,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_204,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_188,this.onFigureUpdate);
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_117,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_686.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_686.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_251 != null)
         {
            this.var_251.events.removeEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
            this.var_251.events.removeEventListener(SongInfoReceivedEvent.const_96,this.onSongInfoReceivedEvent);
            this.var_251 = null;
         }
         this.var_1147 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_545);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_775);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_422);
         _loc1_.push(RoomWidgetUserActionMessage.const_674);
         _loc1_.push(RoomWidgetUserActionMessage.const_535);
         _loc1_.push(RoomWidgetUserActionMessage.const_644);
         _loc1_.push(RoomWidgetUserActionMessage.const_670);
         _loc1_.push(RoomWidgetUserActionMessage.const_989);
         _loc1_.push(RoomWidgetFurniActionMessage.const_315);
         _loc1_.push(RoomWidgetFurniActionMessage.const_749);
         _loc1_.push(RoomWidgetFurniActionMessage.const_855);
         _loc1_.push(RoomWidgetFurniActionMessage.const_993);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1173);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_845);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_867);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_947);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1934);
         _loc1_.push(RoomWidgetPetCommandMessage.const_647);
         _loc1_.push(RoomWidgetPetCommandMessage.const_847);
         _loc1_.push(RoomWidgetUserActionMessage.const_551);
         _loc1_.push(RoomWidgetUserActionMessage.const_272);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_620)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_272 || param1.type == RoomWidgetUserActionMessage.const_551 || param1.type == RoomWidgetUserActionMessage.const_582)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_545:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_775:
            ...
            case RoomWidgetUserActionMessage.const_496:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1215,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_656:
               ...
               break;
            case RoomWidgetUserActionMessage.const_422:
            ...
            case RoomWidgetUserActionMessage.const_535:
               ...
               break;
            case RoomWidgetUserActionMessage.const_644:
            ...
            case RoomWidgetUserActionMessage.const_670:
               ...
               break;
            case RoomWidgetUserActionMessage.const_989:
            ...
            case RoomWidgetFurniActionMessage.const_1173:
               ...
               break;
            case RoomWidgetUserActionMessage.const_272:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_845:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_867:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_947:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_273);
                  ...
                  {
                     _loc12_ = this._container.sessionDataManager.method_4(_loc11_);
                  }
                  if(_loc12_ == null)
                  {
                     return null;
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_395) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_395);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_857) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1361;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_273);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
                  ...
                  {
                     _loc25_ = this._container.sessionDataManager.method_4(_loc24_);
                  }
                  if(_loc25_ != null)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1211);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1387);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_512)
                  {
                     _loc30_ = this.var_251.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_411.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_251.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_507)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_363);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_157)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_892);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_869;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1004;
                  }
      ...
      {
         return [RoomSessionUserBadgesEvent.const_172];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_172:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_686.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_686.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_892);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_251 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_251.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_456,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_251 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_400,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
