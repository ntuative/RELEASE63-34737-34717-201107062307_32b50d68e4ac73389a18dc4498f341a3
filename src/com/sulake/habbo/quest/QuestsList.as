package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private var var_2036:Boolean = true;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_876 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_876.toggle();
         this.var_2036 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1607.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1607[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_606 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_67.spacing = const_1664;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1667;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1665;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1666;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2036 && !this.var_2035)
            {
               this.var_2036 = false;
