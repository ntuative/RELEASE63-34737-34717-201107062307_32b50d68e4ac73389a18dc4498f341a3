package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_1455:int = 8;
      
      private static const const_1449:int = 5;
      
      private static const const_1447:int = 6;
      
      private static const const_1457:int = 3;
      
      private static const const_1456:int = 2;
      
      private static const const_1047:int = 6;
      
      private static const const_1453:int = 180;
      
      private static const const_1450:int = 246;
      
      private static const const_1446:int = 45;
      
      private static const const_1451:Point = new Point(115,93);
      
      private static const const_1445:Point = new Point(72,1);
      
      private static const const_1046:int = 40;
      ...
      private var var_1162:IWindowContainer;
      ...
      private var var_618:ProgressBar;
      
      private var var_765:ProgressBar;
      
      private var var_1161:Matrix;
      
      private var var_1722:ColorMatrixFilter;
      
      private var var_1444:AchievementData;
      
      private var var_767:Timer;
      
      private var var_619:Dictionary;
      
      private var var_764:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         super();
         this.var_51 = param1;
         this.var_520 = new Timer(100,1);
         this.var_520.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_767 = new Timer(2000,1);
         this.var_767.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_764 = new AchievementLevelUp(this.var_51);
         this.var_1161 = new Matrix();
         this.var_1722 = this.createGrayscaleFilter();
         this.var_619[16] = 1;
         this.var_619[28] = 6;
         this.var_619[38] = 4;
         this.var_619[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_520)
         {
            this.var_520.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
            this.var_520.reset();
            this.var_520 = null;
         }
         if(this.var_767)
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1446;
      }
      ...
      private function refreshCategoryListFooter() : void
      {
         if(this._category != null)
         {
            this.var_1162.visible = false;
            return;
         }
         this.var_1162.visible = true;
         this.var_765.refresh(this.var_118.getProgress(),this.var_118.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementList() : void
      {
         ...
         if(this._category == null)
         {
            this.var_768.visible = false;
            return;
         }
         this.var_768.visible = true;
         ...
         this.var_768.height = getLowestPoint(this.var_768);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         ...
         this.var_948.findChildByName("category_name_txt").caption = this.var_51.getAchievementCategoryName(this._category.code);
         ...
         this.var_51.setupAchievementCategoryImage(this.var_948,this._category,false);
      }
      ...
      private function refreshAchievementsFooter() : void
      {
         if(this._category == null)
         {
            this.var_1445.visible = false;
            return;
         }
         this.var_1445.visible = true;
      }
      ...
      private function refreshAchievementDetails() : void
      {
         ...
         this.var_436.findChildByName("achievement_name_txt").caption = this.var_51.localization.getBadgeName(_loc1_);
         ...
         this.var_51.refreshReward(!this.var_72.finalLevel,this.var_436,this.var_72.levelRewardPointType,this.var_72.levelRewardPoints);
         this.refreshBadgeImageLarge(this.var_436,this.var_72);
         this.var_618.refresh(this.var_72.currentPoints,this.var_72.scoreLimit,this.var_72.type * 10000 + this.var_72.level);
         this.var_618.visible = !this.var_72.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_948 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_768 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         this.var_436 = IWindowContainer(this._window.findChildByName("achievement_cont"));
         this.var_1445 = IWindowContainer(this._window.findChildByName("achievements_footer_cont"));
         this.var_1162 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_618 = new ProgressBar(this.var_51,this.var_436,const_1453,"achievements.details.progress",true,const_1451);
         this.var_765 = new ProgressBar(this.var_51,this.var_1162,const_1450,"achievements.categories.totalprogress",true,const_1445);
      }
      ...
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         ...
         var _loc4_:int = Math.floor(param1 / const_685);
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1455) * (param1 % const_685);
            _loc3_.y = (_loc3_.height + const_1449) * Math.floor(param1 / const_685) + const_1447;
         }
      ...
      {
         var _loc9_:* = null;
         var _loc3_:IWindowContainer = IWindowContainer(this.var_768.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_1047);
         var _loc5_:* = _loc4_ < const_1456;
         if(_loc3_ == null)
         {
            if(param2 == null && !_loc5_)
            {
            ...
            _loc3_.x = _loc3_.width * (param1 % const_1047);
            _loc3_.y = _loc3_.height * _loc4_ + const_1454;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc7_:int = const_1046 - _loc5_.height + this.getPositionFix(param2.type);
         var _loc8_:Point = new Point((_loc3_.width - _loc5_.width) / 2,!!_loc6_ ? Number(const_1452) : Number(_loc7_));
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_1722);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc6_:int = 2 * (const_1046 - _loc5_.height + this.getPositionFix(param2.type));
         this.var_1161.identity();
         this.var_1161.scale(2,2);
         this.var_1161.translate((_loc3_.width - _loc5_.width * 2) / 2,_loc6_);
         _loc3_.bitmap.fillRect(_loc3_.bitmap.rect,16777215);
         _loc3_.bitmap.draw(_loc5_,this.var_1161);
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_1722);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_72 = this.var_1444;
         this.var_118.update(this.var_1444);
         this.var_1444 = null;
         this.refresh();
      }
      ...
      {
         return !!this.var_619[param1] ? int(this.var_619[param1]) : 0;
      }
