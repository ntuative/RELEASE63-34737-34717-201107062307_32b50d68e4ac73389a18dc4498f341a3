package com.sulake.habbo.quest
{
   ...
   public class Twinkle implements AnimationObject, IDisposable
   {
      ...
      private static const const_1108:Array = [1,2,3,4,5,6,5,4,3,2,1];
      
      private static const const_1619:int = -1;
      ...
      {
         this.var_1177 = new Point(Math.round(Math.random() * 0),Math.round(Math.random() * 0));
      }
      ...
      public function getBitmap(param1:int) : BitmapData
      {
         ...
         return this._twinkleImages.getImage(const_1108[_loc2_]);
      }
      
      private function getFrame(param1:int) : int
      {
         var _loc2_:int = param1 - this.var_2698;
         if(_loc2_ < 0)
         {
            return const_1619;
         }
         var _loc3_:int = Math.floor(_loc2_ / const_1620);
         if(_loc3_ >= const_1108.length)
         {
            return const_1109;
         }
         return _loc3_;
