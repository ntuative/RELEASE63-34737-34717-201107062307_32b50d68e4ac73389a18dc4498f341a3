package com.sulake.habbo.quest
{
   ...
   public class FriendlyTime
   {
      ...
      private static const const_1093:int = 60;
      
      private static const const_1092:int = 3600;
      
      private static const const_1598:int = 3 * const_1093;
      
      private static const const_1599:int = 3 * const_1092;
      ...
      {
         if(param2 > const_1599)
         {
            return getLocalization(param1,"friendlytime.hours",Math.round(param2 / const_1092));
         }
         if(param2 > const_1598)
         {
            return getLocalization(param1,"friendlytime.minutes",Math.round(param2 / const_1093));
         }
