package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1446:int = 56;
      
      private static const const_475:int = 5;
      
      private static const const_1561:int = 5;
      
      private static const const_1078:Point = new Point(8,8);
      
      private static const const_1562:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc8_.x = const_1078.x;
            _loc8_.y = const_1078.y;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1561;
         }
         _loc3_.visible = !_loc2_;
         var _loc5_:int = this.getTextHeight(_loc3_) - _loc4_;
         var _loc6_:int = this.setupLink("link_region",_loc3_.y + _loc3_.height + const_475);
         ...
         this._window.height = _loc8_.height + const_1446;
      ...
      private function setupLink(param1:String, param2:int) : int
      {
         ...
         {
            _loc7_ = const_475 + _loc6_.height;
         }
         if(!_loc5_ && _loc6_.visible)
         {
            _loc7_ = -const_475 - _loc6_.height;
      ...
      {
         return this.var_130.waitPeriodSeconds < 1 && const_1562.indexOf(this.var_130.type) > -1;
      }
      
      private function hasNavigatorLink() : Boolean
      {
         var _loc1_:Boolean = this.var_51.localization.hasKey(this.var_130.getCampaignLocalizationKey() + ".searchtag");
         var _loc2_:Boolean = this.var_51.localization.hasKey(this.var_130.getCampaignLocalizationKey() + ".searchtag");
         return this.var_130.waitPeriodSeconds < 1 && (_loc1_ || _loc2_);
      }
      ...
      private function onLinkProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this.var_51.openCatalog(this.var_130);
            }
            else if(this.hasNavigatorLink())
            {
               this.var_51.openNavigator(this.var_130);
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1515 = NextQuestTimer.const_796;
         var _loc2_:Boolean = this.var_51.questController.questsList.refreshDelay(this._window,this.var_130);
         if(_loc2_)
         {
