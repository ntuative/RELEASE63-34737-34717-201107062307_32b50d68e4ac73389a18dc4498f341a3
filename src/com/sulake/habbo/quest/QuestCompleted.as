package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private static const const_1560:int = 31;
      ...
      public function prepare(param1:QuestMessageData) : void
      {
         ...
         this._window.findChildByName("catalog_link_txt").caption = this.var_51.localization.getKey("quests.completed.cataloglink." + this.var_130.activityPointType);
         var _loc2_:String = "quests.completed.reward." + this.var_130.activityPointType;
         this.var_51.localization.registerParameter(_loc2_,"amount",this.var_130.rewardCurrencyAmount.toString());
         this._window.findChildByName("reward_txt").caption = this.var_51.localization.getKey(_loc2_,_loc2_);
         this._window.visible = false;
         this._window.findChildByName("congrats_txt").caption = this.var_51.localization.getKey(!!this.var_130.lastQuestInCampaign ? "quests.completed.campaign.caption" : "quests.completed.quest.caption");
         ...
         this.var_51.setupCampaignImage(this._window,param1,this.var_130.lastQuestInCampaign);
         ...
         _loc3_.height = Math.max(const_1560,_loc3_.textHeight + const_1561);
      ...
      {
         this.var_51.localization.registerParameter(param1,"category",this.var_51.getCampaignName(this.var_130));
