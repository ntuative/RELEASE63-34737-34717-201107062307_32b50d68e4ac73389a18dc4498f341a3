package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1600:int = 800;
      
      private static const const_1602:int = 15;
      
      private static const const_1601:int = 300;
      ...
      private var var_1277:QuestController;
      
      private var var_1027:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1277 = new QuestController(this);
         this.var_1027 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1603);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_418.events.removeEventListener(BadgeImageReadyEvent.const_204,this.var_1027.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_418.events.addEventListener(BadgeImageReadyEvent.const_204,this.var_1027.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1277.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1027.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1277.questTracker.isVisible();
      }
