package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1090:Boolean = false;
      
      private static const const_699:String = "Navigation";
      
      private static const const_700:String = "Friend Bar";
      
      private static const const_1587:String = "go.friendbar";
      
      private static const const_1585:String = "chat_btn_click";
      
      private static const const_1583:String = "find_friends_btn_click";
      
      private static const const_1089:String = "Toolbar";
      
      private static const const_1087:String = "open";
      
      private static const const_1088:String = "close";
      
      private static const const_1584:String = "FRIENDLIST";
      
      private static const const_1586:String = "MESSENGER";
      ...
      private var var_88:IHabboFriendList;
      
      private var var_219:IHabboMessenger;
      
      private var var_664:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_88)
            {
               if(!this.var_88.disposed)
               {
                  this.var_88.events.removeEventListener(FriendRequestEvent.const_59,this.onFriendRequestEvent);
                  this.var_88.events.removeEventListener(FriendRequestEvent.const_226,this.onFriendRequestEvent);
               }
               this.var_88.release(new IIDHabboFriendList());
               this.var_88 = null;
            }
            if(this.var_219)
            {
               this.var_219.release(new IIDHabboMessenger());
               this.var_219 = null;
            }
            if(this.var_664)
            {
               this.var_664.release(new IIDHabboEventStream());
               this.var_664 = null;
            }
            this.var_111 = null;
      ...
      {
         return this.var_332.getValue(param1);
      }
      ...
      public function acceptFriendRequest(param1:int) : void
      {
         ...
         if(this.var_88)
         {
            if(!this.var_88.disposed)
            {
               this.var_88.acceptFriendRequest(param1);
            }
         }
      }
      ...
      {
         this.var_121 = [];
         this.var_88.acceptAllFriendRequests();
      ...
      public function declineFriendRequest(param1:int) : void
      {
         ...
         if(this.var_88)
         {
            if(!this.var_88.disposed)
            {
               this.var_88.declineFriendRequest(param1);
            }
         }
      }
      ...
      {
         this.var_121 = [];
         this.var_88.declineAllFriendRequests();
         events.dispatchEvent(new FriendRequestUpdateEvent());
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_699,const_700,const_1587));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_219)
         {
            this.var_219.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_93)
            {
               this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_699,const_700,const_1585));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_699,const_700,const_1583));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_88)
         {
            if(!this.var_88.disposed)
            {
               if(!this.var_88.isOpen())
               {
                  if(this.var_121.length > 0)
                  {
                     this.var_88.openFriendRequests();
                  }
                  else
                  {
                     this.var_88.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_88.mainWindow;
               ...
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1089,const_1584,!!this.var_88.isOpen() ? const_1087 : const_1088));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_219)
         {
            ...
            {
               this.var_219.toggleMessenger();
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1089,const_1586,!!this.var_219.isOpen() ? const_1087 : const_1088));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_664)
         {
            if(!this.var_664.disposed)
            {
               this.var_664.visible = !this.var_664.visible;
            }
         }
      }
      ...
      {
         this.var_1021 = param2 as IHabboConfigurationManager;
         this.var_2603 = this.var_1021.getBoolean("friendbar.notifications.enabled",false);
         this.var_1903 = this.var_1021.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_219 = param2 as IHabboMessenger;
      }
      
      private function onOfflineStreamAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_664 = param2 as IHabboEventStream;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_88 = param2 as IHabboFriendList;
         this.var_88.events.addEventListener(FriendRequestEvent.const_59,this.onFriendRequestEvent);
         this.var_88.events.addEventListener(FriendRequestEvent.const_226,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_332.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_332.remove(_loc8_);
               this.var_111.splice(this.var_111.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_332.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_317)
            {
               ...
               this.var_332.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_317)
            {
               if(this.var_332.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_822 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_219)
         {
            if(this.var_219.isOpen())
            {
               _loc4_ = this.var_219.getActiveConversation();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_822)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_822));
            this.makeNotification(String(this.var_822),FriendNotification.const_459,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_822 = _loc2_.senderId;
         if(this.var_219 && !this.var_219.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_822));
            this.makeNotification(String(this.var_822),FriendNotification.const_459,null,true,false);
         }
      }
