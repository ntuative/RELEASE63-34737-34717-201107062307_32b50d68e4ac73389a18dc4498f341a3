package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2044:String = "friend_requests_tab_xml";
      ...
      protected static const const_2043:String = "badge_counter";
      
      protected static const const_2046:String = "button_accept_all";
      
      protected static const const_2042:String = "click_area_discard_all";
      
      protected static const const_1422:String = "button_close";
      
      protected static const const_2045:String = "button_accept";
      
      protected static const const_1034:String = "click_area_discard";
      ...
      private static const const_1085:uint = 4294957414;
      
      private static const const_1580:uint = 4289431312;
      
      private static const const_1581:uint = 4290616362;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1582:uint = 16777215;
      ...
      private var var_1258:IWindowContainer;
      ...
      public static function allocate(param1:Array) : FriendRequestsTab
      {
         ...
         _loc2_._window.findChildByName(const_2043).caption = String(param1.length);
         return _loc2_;
      }
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_1891)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1258.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1580) : uint(const_1581);
                           ...
                           _loc9_ = var_502.getAvatarFaceBitmap(_loc5_.figure);
                           if(_loc9_)
                           {
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2044).content as XML) as IWindowContainer;
         ...
         this.var_1258 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1034)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1413)).textColor = const_1582;
            }
         }
      }
