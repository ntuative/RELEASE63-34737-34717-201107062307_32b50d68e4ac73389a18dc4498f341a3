package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1709:String = "entity_xml";
      ...
      protected static const const_1113:String = "btn_message";
      ...
      protected static const const_661:String = "notification";
      
      private static const const_75:uint = 10338138;
      
      private static const const_1085:uint = 13891476;
      
      private static const const_1155:String = null;
      
      private static const const_725:String = "icon_tag_notify";
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_661,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            if(this.friend.online)
            {
               ...
               _loc8_ = _loc3_.getChildByName(const_1113);
               if(_loc8_)
               {
      ...
      {
         super.expose();
         _window.color = !!exposed ? uint(const_1085) : uint(const_75);
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_168)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1039)).getListItemByName(const_469) as IWindowContainer;
            _loc1_.findChildByName(const_681).caption = this.var_168.name;
            var_2246.crop(_loc1_.getChildByName(const_681) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_316));
            _loc2_.bitmap = var_502.getAvatarFaceBitmap(this.var_168.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_486.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1709).content as XML) as IWindowContainer;
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1113:
               case const_1038:
                  this.removeNotificationToken(FriendNotification.const_459,true);
                  if(var_357 && this.var_168)
                  {
                     var_357.startConversation(this.var_168.id);
                     this.deselect(true);
                     if(param1.window.name == const_1038)
                     {
                        var_502.setMessengerIconNotify(false);
                     }
                  }
                  break;
               case const_1420:
                  if(var_357 && this.var_168)
                  {
                     var_357.followToRoom(this.var_168.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1155;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1311:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2225);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_725;
               break;
            case FriendNotification.const_1320:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2225);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_725;
               break;
            case FriendNotification.const_459:
