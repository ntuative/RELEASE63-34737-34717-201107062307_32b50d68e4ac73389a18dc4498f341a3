package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2054:String = "friend_request_tab_xml";
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1535 ? var_1535 : new FriendRequestTab();
         ...
         if(_loc2_.friend)
         {
            if(_loc2_.friend.figure != param1.figure)
            {
               ...
               _loc3_.bitmap = var_502.getAvatarFaceBitmap(param1.figure);
            }
         }
      ...
      {
         var _loc6_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2054).content as XML) as IWindowContainer;
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_352,WindowStyle.const_104,WindowParam.const_31,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_401,WindowStyle.const_104,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2045:
                  var_357.acceptFriendRequest(var_168.id);
                  break;
               case const_1422:
                  if(selected)
                  {
                  ...
                  break;
               case const_1037:
                  var_357.declineFriendRequest(var_168.id);
            }
         }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1037)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1582;
            }
         }
      }
         ...
         if(!disposed)
         {
            if(friend)
            {
               if(friend.figure == param1.figure)
               {
                  ...
                  if(_loc3_)
                  {
                     _loc4_ = var_502.getAvatarFaceBitmap(param1.figure);
                     if(_loc4_)
                     {
