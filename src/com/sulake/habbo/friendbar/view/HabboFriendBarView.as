package com.sulake.habbo.friendbar.view
{
   ...
   public class HabboFriendBarView extends AbstractView implements IHabboFriendBarView, IAvatarImageListener
   {
      ...
      private static const const_1519:int = 127;
      ...
      private static const const_1520:Boolean = false;
      
      private static const const_689:int = 3;
      
      private static const const_1521:String = "arrow";
      
      private static const const_1510:String = "left";
      
      private static const const_1513:String = "right";
      
      private static const const_1509:String = "bar_xml";
      
      private static const const_1514:String = "toggle_xml";
      
      private static const const_72:String = "container";
      
      private static const const_1057:String = "wrapper";
      
      private static const const_1517:String = "border";
      
      private static const const_687:String = "list";
      ...
      private static const const_1516:String = "button_right";
      
      private static const const_1515:String = "button_left_page";
      
      private static const const_1507:String = "button_right_page";
      
      private static const const_1512:String = "button_left_end";
      
      private static const const_1522:String = "button_right_end";
      
      private static const const_1422:String = "button_close";
      
      private static const const_1508:String = "button_open";
      
      private static const const_1511:String = "link_friendlist";
      
      private static const const_1056:String = "messenger";
      
      private static const const_1059:String = "friendlist";
      
      private static const const_688:String = "stream";
      ...
      private var var_1196:ITab;
      
      private var var_982:int = -1;
      
      private var _startIndex:int = 0;
      
      private var var_1485:TextCropper;
      
      private var var_533:FriendListIcon;
      
      private var var_379:MessengerIcon;
      
      private var var_793:StreamIcon;
         ...
         if(!disposed)
         {
            ...
            if(this.var_49)
            {
               if(!this.var_49.disposed)
               {
                  ...
                  {
                     this.var_49.events.removeEventListener(FriendBarUpdateEvent.const_998,this.onRefreshView);
                     this.var_49.events.removeEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
                     this.var_49.events.removeEventListener(FriendRequestUpdateEvent.const_1027,this.onFriendRequestUpdate);
                     this.var_49.events.removeEventListener(NewMessageEvent.const_831,this.onNewInstantMessage);
                     this.var_49.events.removeEventListener(NotificationEvent.const_738,this.onFriendNotification);
                  }
      ...
      public function populate() : void
      {
         ...
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_687) as IItemListWindow;
         ...
         var _loc9_:int = _loc6_ + (!!this.var_1484 ? 1 : 0) + (_loc7_ > 0 ? 1 : 0);
         ...
         if(this.var_1484)
         {
            ...
            {
               _loc15_ = 1;
               if(this.var_74.length + _loc15_ < const_689)
               {
                  _loc15_ = Math.min(_loc8_ - this.var_74.length,const_689 - this.var_74.length);
               }
      ...
      private function onFriendBarDataAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_49.events.addEventListener(FriendBarUpdateEvent.const_998,this.onRefreshView);
         this.var_49.events.addEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
         this.var_49.events.addEventListener(FriendRequestUpdateEvent.const_1027,this.onFriendRequestUpdate);
         this.var_49.events.addEventListener(NewMessageEvent.const_831,this.onNewInstantMessage);
         this.var_49.events.addEventListener(NotificationEvent.const_738,this.onFriendNotification);
      }
      ...
      private function buildUserInterface() : void
      {
         ...
         Tab.var_2225 = var_753;
         Tab.var_2246 = this.var_1485;
         Token.WINDOWING = _windowManager;
         Token.ASSETS = assets;
         var _loc1_:IAsset = assets.getAssetByName(const_1509);
         this.var_45 = _windowManager.buildFromXML(_loc1_.content as XML,const_471) as IWindowContainer;
         this.var_45.x = const_690;
         this.var_45.y = this.var_45.parent.height - (this.var_45.height + const_1518);
         this.var_45.width = this.var_45.parent.width - (const_690 + const_1058);
         this.var_45.setParamFlag(WindowParam.const_304,true);
         this.var_45.procedure = this.barWindowEventProc;
         if(const_1520)
         {
            _loc1_ = assets.getAssetByName(const_1514);
            this.var_215 = _windowManager.buildFromXML(_loc1_.content as XML,const_471) as IWindowContainer;
            this.var_215.x = this.var_45.x;
            this.var_215.y = this.var_45.y;
            this.var_215.setParamFlag(WindowParam.const_304,true);
            this.var_215.visible = false;
            this.var_215.procedure = this.toggleWindowEventProc;
         }
         _loc2_ = IWindowContainer(this.var_45.findChildByName(const_1059));
         ...
         this.var_533 = new FriendListIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         _loc2_ = IWindowContainer(this.var_45.findChildByName(const_1056));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_379 = new MessengerIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         this.var_379.enable(false);
         this.visible = true;
         _windowManager.getWindowContext(const_471).getDesktopWindow().addEventListener(WindowEvent.const_40,this.onDesktopResized);
         this.var_45.findChildByName(const_688).visible = var_1074.getBoolean("friendbar.stream.enabled",false) == true;
         _loc2_ = IWindowContainer(this.var_45.findChildByName(const_688));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_793 = new StreamIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(var_603)
         {
            _loc3_ = var_603.createAvatarImage(param1,AvatarScaleType.const_62,null,this);
            if(_loc3_)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         var _loc3_:IItemListWindow = this.var_45.findChildByName(const_687) as IItemListWindow;
      ...
      private function onFindFriendsNotification(param1:FindFriendsNotificationEvent) : void
      {
         ...
         {
            param1.dispose();
         },HabboAlertDialogFlag.const_511);
      }
      ...
      private function onFriendRequestUpdate(param1:FriendRequestUpdateEvent) : void
      {
         if(this.var_533)
         {
            this.var_533.notify(this.var_49.numFriendRequests > 0);
         }
         this.populate();
      }
      ...
      private function onNewInstantMessage(param1:NewMessageEvent) : void
      {
         if(this.var_379)
         {
            if(param1.notify)
            {
               this.var_379.notify(true);
            }
            else
            {
               this.var_379.enable(true);
            }
         }
      }
      ...
      private function barWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            _loc4_ = this.var_49.numFriends + (!!this.var_1484 ? 1 : 0) + (this.var_49.numFriendRequests > 0 ? 1 : 0);
            switch(param2.name)
            {
      ...
      private function toggleArrowButtons(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:IWindowContainer = this.var_45.findChildByName(const_1057) as IWindowContainer;
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1521,_loc5_);
         ...
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1513,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param3)
            {
         ...
         if(!disposed)
         {
            if(this.var_45)
            {
               ...
               if(!param1)
               {
                  ...
                  {
                     if(this.var_74.length < const_689)
                     {
                        param1 = true;
                     }
                     else if(this.var_74.length < this.var_49.numFriends + (!!this.var_1484 ? 1 : 0))
                     {
                        param1 = true;
                     }
      ...
      private function get maxNumOfTabsVisible() : int
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getChildByName(const_1057) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_687) as IItemListWindow;
         var _loc4_:int = _loc2_.width - _loc3_.width;
         return (_loc1_.width - _loc4_) / (const_1519 + _loc3_.spacing);
      }
