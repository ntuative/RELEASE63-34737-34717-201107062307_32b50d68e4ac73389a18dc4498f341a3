package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1685:uint = 16777215;
      
      private static const const_1686:uint = 12247545;
      
      private static const const_1684:String = "HELP";
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_368 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_67.removeListItem(this.var_368);
      }
      
      public function showRoomInfo() : void
      {
         this.var_67.addListItemAt(this.var_368,0);
      }
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_349)
         {
            this.var_349 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_349.x = _loc1_.x + this._window.width - this.var_349.width;
            this.var_349.y = _loc1_.y + this._window.height - this.var_349.height;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1684);
               break;
