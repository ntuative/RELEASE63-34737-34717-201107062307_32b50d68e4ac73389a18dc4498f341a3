package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1439:String = "purse";
      
      private static const const_1440:String = "extra_tools";
      ...
      private var var_617:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1159:PurseExtension;
      
      private var var_1439:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_616:ExtensionView;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_310.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_310 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
            this.var_310.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            unlock();
         }
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_616 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_616)
            {
               this.var_1159 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_617 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
               {
                  this.var_1439 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_616.attachExtension(const_1439,this.var_1159.window,ExtensionFixedSlotsEnum.const_1907);
               this.var_616.attachExtension(const_1440,this.var_617.window,ExtensionFixedSlotsEnum.const_1750);
            }
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_617.showRoomInfo();
         }
         else
         {
            this.var_617.hideRoomInfo();
         }
      }
