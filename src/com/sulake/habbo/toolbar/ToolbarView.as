package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1545:Point = new Point(3,3);
      
      private static const const_1594:uint = 7433577;
      
      private static const const_1590:uint = 5723213;
      
      private static const const_478:String = "_hover";
      
      private static const const_479:String = "_normal";
      
      private static const const_477:int = 5;
      
      private static const const_1589:int = 600;
      
      private static const const_1595:int = 80;
      
      private static const const_1591:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1593:int = -2;
      
      private static const const_1592:int = 5;
      ...
      private var var_1542:BitmapData;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1545;
         this._window.addEventListener(WindowEvent.const_609,this.onParentResized);
         ...
         {
            this.setIconHoverState(_loc11_,const_479);
         }
         ...
         this.var_220.x = _loc13_.width - this.var_220.width - const_477;
         this.var_220.y = const_477;
         this.var_2607 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1589;
         if(!param1 && _loc2_ == this.var_1541)
         {
            return;
         }
         this.var_1541 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1591) : int(const_1595);
         var _loc4_:int = !!_loc2_ ? int(const_1593) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1592 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1596;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_220 != null && this.var_2607)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_754:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_791:
               _loc3_ = true;
         }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_478 ? this.var_1543 : this.var_1542;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_478)
         {
            param1.color = const_1594;
         }
         else
         {
            param1.color = const_1590;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1541 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1541 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         if(this.var_1542)
         {
            this.var_1542.dispose();
         }
         this.var_1542 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1543)
         {
            this.var_1543.dispose();
         }
         this.var_1543 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1023.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
