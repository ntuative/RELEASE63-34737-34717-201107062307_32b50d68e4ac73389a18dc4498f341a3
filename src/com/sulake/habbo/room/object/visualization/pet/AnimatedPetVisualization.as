package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1671:String = "head";
      
      private static const const_710:int = 1;
      
      private static const const_1123:int = 1000;
      
      private static const const_1670:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1670) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_406 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2804)
            {
               this.var_2804 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_246);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_174);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_246);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_174);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1947 = _loc3_.getNumber(RoomObjectVariableEnum.const_265) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_216);
            if(!isNaN(_loc8_))
            {
            ...
            this.var_1529 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2517 = _loc3_.getNumber(RoomObjectVariableEnum.const_446);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_777);
            if(_loc9_ != this.var_2048)
            {
               this.var_2048 = _loc9_;
               this.var_2803 = this.var_2048.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_406 != null)
         {
            ...
            if(this.var_1529 > 0)
            {
               _loc2_ = param1 - this.var_1529;
               if(_loc2_ < const_1123)
               {
                  this.var_406.alpha = int(Math.sin(_loc2_ / const_1123 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_406.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_406.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_710;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2803);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_710)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_710))
            {
               if(param2 >= FurnitureVisualizationData.const_606.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_606[param2];
               if(_loc4_ == 1)
               {
      ...
      {
         if(this.var_1082[param1] == null)
         {
            if(this._animationData.getTag(var_103,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1671)
            {
               this.var_1082[param1] = true;
            }
            else
            {
               this.var_1082[param1] = false;
            }
         }
