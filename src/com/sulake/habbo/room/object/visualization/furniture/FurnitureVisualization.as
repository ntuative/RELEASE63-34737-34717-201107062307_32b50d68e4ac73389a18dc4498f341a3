package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_2053:Number = Math.sqrt(0.5);
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1599 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1599;
            this.var_1599 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_645 != spriteCount)
         {
            createSprites(this.var_645);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2737;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_405:
               break;
            case LayerData.const_1255:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1345:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_509 != _loc3_.getUpdateID() || param1 != var_103 || param2 != this.var_2756)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2757 = _loc3_.getNumber(RoomObjectVariableEnum.const_286);
            ...
            this.var_1331 = this.getAdClickUrl(_loc3_);
            if(this.var_1331 == null || this.var_1331.indexOf("http") != 0)
            {
               this.var_1331 = null;
            }
            this.var_2737 = this.var_1331 != null;
            this.var_2760 = _loc3_.getNumber(RoomObjectVariableEnum.const_829);
      ...
      {
         if(this.var_2759 != param2 || this.var_2758 != param1)
         {
            this.var_1070 = [];
            this.var_1071 = [];
            this.var_870 = [];
            ...
            this.var_2761 = this.getSize(param1);
      ...
      {
         this.var_645 = param1;
         this.var_1600 = this.var_645 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_606.length)
         {
            return "";
         }
         var _loc3_:String = this.var_1070[param2];
         var _loc4_:Boolean = this.var_1071[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2761;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1600)
            {
               _loc6_ = FurnitureVisualizationData.const_606[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_1070[param2] = _loc3_;
            this.var_1071[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_868[param3] != null && !this.var_2011)
         {
      ...
      {
         if(this.var_867[param2] != null)
         {
            return this.var_867[param2];
         }
         if(this._data == null)
         {
      ...
      {
         var _loc4_:int = 0;
         if(param3 != this.var_1600)
         {
            if(this.var_864[param3] != null)
            {
               return this.var_864[param3];
            }
            if(this._data != null)
            {
               _loc4_ = this._data.getYOffset(param1,param2,param3);
               this.var_864[param3] = _loc4_;
               return _loc4_;
            }
      ...
      {
         if(this.var_866[param3] != null)
         {
            return this.var_866[param3];
         }
         if(this._data == null)
         {
            return true;
      ...
      {
         if(this.var_865[param3] != null)
         {
            return this.var_865[param3];
         }
         if(this._data == null)
         {
