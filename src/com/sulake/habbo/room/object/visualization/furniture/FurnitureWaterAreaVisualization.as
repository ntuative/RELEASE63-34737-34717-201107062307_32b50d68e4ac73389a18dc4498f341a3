package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1687:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1356)
            {
      ...
      {
         if(this.var_2831 == param1 && this.var_2830 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1687)
            {
               this.var_2066 = _loc2_;
               this.var_2831 = param1;
               this.var_2830 = direction;
               return this.var_2066;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1356.indexOf(_loc2_) < 0)
            {
               this.var_1356.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_571 + 2;
         var _loc4_:int = this.var_706 + 2;
         var _loc5_:int = 0;
         ...
         this.var_2065 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_481.length)
         {
            if(this.var_481[_loc5_] == true)
            {
               this.var_2065 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_571 == 0 || this.var_706 == 0)
         {
            ...
            this.var_571 = _loc2_.getNumber(RoomObjectVariableEnum.const_310);
            this.var_706 = _loc2_.getNumber(RoomObjectVariableEnum.const_357);
         }
         this.var_481 = [];
         this.var_707 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_571 * 2 + this.var_706 * 2)
         {
            this.var_481.push(false);
            this.var_707.push(ShoreMaskCreatorUtility.const_84);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_571 + 2;
         var _loc2_:int = this.var_706 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_80,getSize(param3),this.var_481,this.var_707,assetCollection);
      }
