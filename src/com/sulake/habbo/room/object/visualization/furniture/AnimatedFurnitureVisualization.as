package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_129:AnimationStateData;
      
      private var var_1828:int = 0;
      
      private var var_450:Number = 0;
      ...
      {
         super();
         this.var_129 = new AnimationStateData();
      }
      ...
      {
         return this.var_129.animationId;
      }
      
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         var _loc2_:int = this.animationId;
         if(_loc2_ != const_1277 && this._animationData.hasAnimation(this.var_450,_loc2_))
         {
            return _loc2_;
         }
         return const_1277;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_914);
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc5_ = _loc3_.getNumber(RoomObjectVariableEnum.const_914);
                     if(_loc5_ > this.var_1828)
                     {
                        this.var_1828 = _loc5_;
                        this.setAnimation(this._state);
                     }
                  }
                  _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_810);
                  if(!isNaN(_loc4_))
                  {
                     _loc6_ = this._animationData.getAnimationId(this.var_450,_loc4_);
      ...
      protected function setAnimation(param1:int) : void
      {
         ...
         {
            this.setSubAnimation(this.var_129,param1,this._state >= 0);
         }
      }
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_450,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_450,_loc6_))
                  {
      ...
      {
         return this.var_129.getLastFramePlayed(param1);
      }
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_129 != null)
         {
            this.var_129.setLayerCount(this.var_645);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         {
            this.var_450 = param1;
            this.var_645 = this._animationData.getLayerCount(param1);
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_129.animationOver || this.var_995)
         {
            _loc2_ = this.updateFramesForAnimation(this.var_129,param1);
            if(this.var_129.animationOver)
            {
               if(AnimationData.isTransitionFromAnimation(this.var_129.animationId) || AnimationData.isTransitionToAnimation(this.var_129.animationId))
               {
                  this.setAnimation(this.var_129.animationAfterTransitionId);
                  this.var_129.animationOver = false;
               }
            }
         }
         return _loc2_;
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_995)
         {
            return 0;
         }
         ...
         var _loc7_:* = 1 << this.var_645 - 1;
         var _loc8_:int = this.var_645 - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = param1.getAnimationPlayed(_loc8_);
            if(!_loc9_ || this.var_995)
            {
               ...
               if(this.var_995 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
                  ...
                  if(_loc12_ == AnimationFrame.const_1305)
                  {
      ...
      {
         var _loc3_:AnimationFrame = this.var_129.getFrame(param2);
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_129.getFrame(param3);
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
