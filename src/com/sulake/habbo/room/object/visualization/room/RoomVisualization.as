package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1730:int = 16777215;
      
      public static const const_1999:int = 13421772;
      
      private static const const_1107:int = 16777215;
      
      private static const const_1106:int = 13421772;
      
      private static const const_1104:int = 10066329;
      
      private static const const_1105:int = 10066329;
      
      public static const const_1815:int = 16777215;
      
      public static const const_1746:int = 13421772;
      
      public static const const_1751:int = 10066329;
      ...
      private var var_849:Rectangle = null;
      
      private var var_557:RoomPlaneBitmapMaskParser = null;
      
      private var var_1577:String = null;
      
      private var _floorType:String = null;
      
      private var var_1578:String = null;
      
      private var var_988:Number = NaN;
      
      private var var_1492:Number = NaN;
      
      private var var_2696:Number = NaN;
      
      private var var_1959:String = null;
      
      private var var_1298:uint = 16777215;
      
      private var var_2695:int = 255;
      
      private var var_2694:int = 255;
      
      private var var_2697:int = 255;
      ...
      private const const_2359:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_557 = new RoomPlaneBitmapMaskParser();
         this.var_340["null"] = false;
         this.var_340["null"] = true;
         this.var_340["null"] = true;
         this.var_340["null"] = true;
      }
      ...
      private function resetRoomPlanes() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_158.length)
            {
               _loc2_ = this.var_158[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_849 = super.boundingRectangle;
         }
         return new Rectangle(this.var_849.x,this.var_849.y,this.var_849.width,this.var_849.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_158.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_158[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_988))
         {
            this._planeParser.floorThicknessMultiplier = this.var_988;
         }
         if(!isNaN(this.var_1492))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1492;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_931);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1388);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_452)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1815;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1746;
               }
               else
               {
                  _loc13_.color = const_1751;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1849)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_79,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_452)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2359 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_396.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1958)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2697 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2694 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2695 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1833)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1571 || _loc3_.y != this.var_2690 || _loc3_.z != this.var_2692 || param1.scale != this.var_1960))
            {
               this.var_1571 = _loc3_.x;
               this.var_2690 = _loc3_.y;
               this.var_2692 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1230);
            if(_loc3_ != this.var_1959)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1959 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_910));
            if(_loc4_ != this.var_1298)
            {
               this.var_1298 = _loc4_;
               this.var_2697 = this.var_1298 & 255;
               this.var_2694 = this.var_1298 >> 8 & 255;
               this.var_2695 = this.var_1298 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1227));
            if(_loc5_ != this.var_1958)
            {
               this.var_1958 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_148 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_227);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_832));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_985));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_966));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_148 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1307);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1303);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_988 || _loc3_ != this.var_1492))
            {
               this.var_988 = _loc2_;
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_148 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1383);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2696)
            {
               this.var_2696 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_158.length)
         {
            _loc5_ = this.var_158[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      {
         if(param1 != this.var_340["null"] || param2 != this.var_340["null"] || param3 != this.var_340["null"])
         {
            this.var_340["null"] = param1;
            this.var_340["null"] = param2;
            this.var_340["null"] = param3;
            this.var_396 = [];
            this.var_679 = [];
         }
      }
         ...
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_340[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1297;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_557.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         {
            _loc3_ = this.var_158[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_557.maskCount)
         {
            _loc10_ = this.var_557.getMaskType(_loc8_);
            _loc11_ = this.var_557.getMaskLocation(_loc8_);
            _loc12_ = this.var_557.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_158.length)
               {
                  _loc3_ = this.var_158[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_79 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_251)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_158[_loc18_] as RoomPlane;
