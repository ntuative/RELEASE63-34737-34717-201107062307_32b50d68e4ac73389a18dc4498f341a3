package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_229,RoomObjectRoomAdEvent.const_354,RoomObjectRoomAdEvent.const_324];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_415,"");
         _loc2_.setString(RoomObjectVariableEnum.const_813,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_637,Number(false));
         this.var_873 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1217:
                  _loc2_.setString(RoomObjectVariableEnum.const_415,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_813,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_637,Number(true));
                  this.var_1517 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1352);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_637,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_813);
                  if(_loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_229,_loc5_,_loc6_,_loc7_));
