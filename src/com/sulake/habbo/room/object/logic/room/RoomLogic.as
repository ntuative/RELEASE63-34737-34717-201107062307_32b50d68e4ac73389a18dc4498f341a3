package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1765:int = 255;
      
      private var var_1472:uint = 16777215;
      
      private var var_1763:int = 255;
      
      private var var_1191:uint = 16777215;
      
      private var var_1762:int = 255;
      
      private var var_1192:int = 0;
      
      private var var_1764:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_534,RoomObjectMouseEvent.const_164];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_931,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_910,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_832,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_985,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_966,1);
         }
      }
         ...
         if(this.var_1471)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_931,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1383,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1192)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1765;
            if(_loc2_ - this.var_1192 >= this.var_1764)
            {
               _loc3_ = this.var_1191;
               _loc4_ = this.var_1762;
               this.var_1192 = 0;
            }
            else
            {
               _loc7_ = this.var_1472 >> 16 & 255;
               _loc8_ = this.var_1472 >> 8 & 255;
               _loc9_ = this.var_1472 & 255;
               _loc10_ = this.var_1191 >> 16 & 255;
               _loc11_ = this.var_1191 >> 8 & 255;
               _loc12_ = this.var_1191 & 255;
               _loc13_ = (_loc2_ - this.var_1192) / this.var_1764;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1763 + (this.var_1762 - this.var_1763) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_910,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_821:
               param2.setString(RoomObjectVariableEnum.const_217,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_955:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_599:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_251)
               {
                  _loc5_ = "null";
               }
               this.var_557.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_854:
               _loc4_ = this.var_557.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_557.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1230,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1384:
               param2.setNumber(RoomObjectVariableEnum.const_832,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1226:
               param2.setNumber(RoomObjectVariableEnum.const_985,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_966,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_692:
               param2.setNumber(RoomObjectVariableEnum.const_1307,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1189:
               param2.setNumber(RoomObjectVariableEnum.const_1303,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_179:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1472 = this._color;
         this.var_1763 = this.var_1765;
         this.var_1191 = _loc3_;
         this.var_1762 = _loc4_;
         this.var_1192 = getTimer();
         this.var_1764 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_544,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1939,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1967,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1856,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_544,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_255 || _loc12_ == RoomPlaneData.const_452)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
