package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureFloorHoleLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFloorHoleEvent.const_179,RoomObjectFloorHoleEvent.const_144];
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc4_ != this.var_1236)
               {
                  if(eventDispatcher != null)
                  {
                     if(_loc4_ == const_474)
                     {
                        eventDispatcher.dispatchEvent(new RoomObjectFloorHoleEvent(RoomObjectFloorHoleEvent.const_179,object.getId(),object.getType()));
                     }
                     else if(this.var_1236 == const_474)
                     {
                        eventDispatcher.dispatchEvent(new RoomObjectFloorHoleEvent(RoomObjectFloorHoleEvent.const_144,object.getId(),object.getType()));
                     }
                  }
