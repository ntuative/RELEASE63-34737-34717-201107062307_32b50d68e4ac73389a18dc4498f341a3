package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_499,RoomObjectFurnitureActionEvent.const_502,RoomObjectFurnitureActionEvent.const_665,RoomObjectFurnitureActionEvent.const_595,RoomObjectWidgetRequestEvent.const_147];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_816) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_395,RoomWidgetInfostandExtraParamEnum.const_512);
