package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_514,RoomObjectFurnitureActionEvent.const_561,RoomObjectFurnitureActionEvent.const_601,RoomObjectFurnitureActionEvent.const_500];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_1236)
         {
            this.var_1236 = _loc3_;
            if(_loc3_ == 1)
            {
