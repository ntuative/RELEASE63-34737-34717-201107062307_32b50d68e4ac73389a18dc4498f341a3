package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_3073:Array;
      
      private var var_1823:GroupDetailsView;
      ...
      private var var_641:ProductDataParser;
      ...
      private var var_1821:UserTagManager;
      
      private var var_1217:BadgeImageManager;
      
      private var var_1219:HabboGroupInfoManager;
      
      private var var_993:IgnoredUsersManager;
      ...
      private var var_1220:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_3073 = [];
         this.var_1821 = new UserTagManager(events);
         this.var_1219 = new HabboGroupInfoManager(this,events);
         this.var_993 = new IgnoredUsersManager(this);
         this.var_1220 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_325)
         {
            this.var_325.removeEventListener(FurnitureDataParser.const_122,this.onFurnitureReady);
            this.var_325.dispose();
            this.var_325 = null;
         }
         if(this.var_641)
         {
            this.var_641.removeEventListener(ProductDataParser.const_122,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         if(this.var_142 == null || this._localization == null)
         {
            return;
         }
         this.var_1217 = new BadgeImageManager(context.root.assets,events,this.var_142,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1821.communication = this._communication;
         this.var_1219.communication = this._communication;
         this.var_1220.communication = this._communication;
         this.var_993.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_325)
         {
            ...
            this.var_325 = new FurnitureDataParser(this.var_537,this._wallItems,this.var_538,this._localization);
            this.var_325.addEventListener(FurnitureDataParser.const_122,this.onFurnitureReady);
            if(this.var_142.keyExists("furnidata.load.url"))
            {
               _loc3_ = this.var_142.getKey("furnidata.load.url");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_1825 = _loc2_.clubLevel;
         this.var_1822 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2622 = _loc3_.respectTotal;
         this.var_1218 = _loc3_.respectLeft;
         this.var_802 = _loc3_.petRespectLeft;
         this._figure = _loc3_.figure;
         this.var_1030 = _loc3_.sex;
         this.var_1814 = _loc3_.realName;
         this.var_2466 = _loc3_.identityId;
         this.var_993.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            this.var_1030 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this._figure,this.var_1030));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2467 = _loc2_.isOpen;
         this.var_2468 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1822 >= SecurityLevelEnum.const_1367;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1821.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1217.getBadgeImage(param1);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_1217.getBadgeImageWithInfo(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1823 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1219.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1823.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1219.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1219.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1217.getBadgeImage(param1,BadgeImageManager.const_1325);
      }
      ...
      {
         return this.var_993.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_993.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_993.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1218 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1218 = this.var_1218 - 1;
      }
      
      public function givePetRespect(param1:int) : void
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_802 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_802 = this.var_802 - 1;
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_537.getValue(param1.toString());
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_538.getValue(param1);
      ...
      public function openHabboHomePage(param1:int) : void
      {
         ...
         {
            urlString = this.var_142.getKey("link.format.userpage");
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1216.indexOf(param1) == -1)
         {
         ...
         {
            _loc2_ = this.var_142.getKey("productdata.load.url");
            this.var_641 = new ProductDataParser(_loc2_,this.var_1336);
            this.var_641.addEventListener(ProductDataParser.const_122,this.onProductsReady);
         }
         return false;
      }
      ...
      private function onProductsReady(param1:Event) : void
      {
         ...
         this.var_641.removeEventListener(ProductDataParser.const_122,this.onProductsReady);
         this.var_1824 = true;
         for each(_loc2_ in this.var_1216)
         {
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         var _loc2_:Array = this.var_537.getValues();
