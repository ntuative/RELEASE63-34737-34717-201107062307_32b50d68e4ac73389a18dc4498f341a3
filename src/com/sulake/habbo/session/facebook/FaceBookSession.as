package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1053:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1484:String = "sendAccessTokenToServer";
      
      private static const const_1483:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1484,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1483,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1053);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1053);
         }
      }
