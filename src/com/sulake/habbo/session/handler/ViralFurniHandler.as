package com.sulake.habbo.session.handler
{
   ...
   public class ViralFurniHandler extends BaseHandler
   {
      ...
      private function onViralFurniStatus(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:RoomSessionViralFurniStatusEvent = new RoomSessionViralFurniStatusEvent(RoomSessionViralFurniStatusEvent.const_651,_loc6_);
      ...
      private function onViralGiftReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:RoomSessionViralFurniStatusEvent = new RoomSessionViralFurniStatusEvent(RoomSessionViralFurniStatusEvent.const_677,_loc4_);
         _loc5_.firstClickUserName = _loc3_.firstClickUserName;
         _loc5_.method_2 = _loc3_.method_2;
         if(listener && false)
         {
