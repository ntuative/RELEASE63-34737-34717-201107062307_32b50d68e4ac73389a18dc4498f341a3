package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_520:int = 70;
      
      public static const const_1889:int = 5;
      
      private static const name_4:int = 0;
      
      private static const const_634:int = 1;
      ...
      private var var_257:HabboNotificationItem;
      
      private var var_1795:Boolean = false;
      
      private var var_1249:Map;
      
      private var var_987:Map;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1796 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1796 = 15;
         }
         this.var_1797 = this._window.height;
         this.var_1489 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      {
         if(param1.badgeId != this.var_257.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_634:
               ...
               _loc2_ = Number(this.var_1206) / Number(this.var_987["time_fade_in"]);
               if(this.var_1206 > int(this.var_987["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1064:
               ...
               if(this.var_1490 > int(this.var_987["time_display"]) && !this.var_1795)
               {
                  this.startFadeOut();
               }
               break;
            case const_1065:
               ...
               _loc3_ = 1 - Number(this.var_1205) / Number(this.var_987["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1205 > int(this.var_987["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1796;
         if(this._window.height < this.var_1797)
         {
            this._window.height = this.var_1797;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1889;
         this._window.y = this.var_1489;
      }
