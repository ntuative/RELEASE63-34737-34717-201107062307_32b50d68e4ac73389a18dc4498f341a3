package com.sulake.habbo.help.help.data
{
   ...
   public class FaqCategory
   {
      ...
      public function method_3(param1:int) : Boolean
      {
      ...
      {
         this.var_2080 = new Date();
      }
      
      public function getAgeSeconds() : Number
      {
         if(this.var_2080 == null)
         {
            return new Date().valueOf();
         }
         return (new Date().valueOf() - this.var_2080.valueOf()) / 1000;
      }
