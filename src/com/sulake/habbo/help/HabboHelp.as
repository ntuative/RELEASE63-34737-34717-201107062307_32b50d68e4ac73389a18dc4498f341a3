package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_872:HotelMergeUI;
      
      private var var_1601:CallForHelpData;
      
      private var var_2764:UserRegistry;
      
      private var var_2560:String = "";
      
      private var var_1073:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1601 = new CallForHelpData();
         this.var_2764 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1333 = new FaqIndex();
      ...
      {
         this.var_1601.reportedUserId = param1;
         this.var_1601.reportedUserName = param2;
         this.var_76.showUI(HabboHelpViewEnum.const_443);
      }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_872)
         {
            this.var_872 = new HotelMergeUI(this);
         }
         this.var_872.startNameChange();
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_122)
         {
            this.var_122.showView(TutorialUI.const_356);
         }
      }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_1073)
         {
            this.var_1073 = new WelcomeScreenController(this,this._windowManager);
         }
         this.var_1073.showWelcomeScreen(param1);
      }
