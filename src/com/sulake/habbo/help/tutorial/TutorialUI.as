package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_356:String = "TUI_NAME_VIEW";
      
      public static const const_430:String = "TUI_CLOTHES_VIEW";
      
      public static const const_508:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_414:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_564,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_592,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_583,this.onTaskDoneEvent);
         if(this.var_35.sessionDataManager != null)
         {
            this.var_35.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_333,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1377 && this.var_1376 && this.var_1663;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_564,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_592,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_583,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
               this.var_35.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_333,this.onFigureUpdate);
            }
            this.var_35 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_54 == null || this.var_54.id == const_100)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_564:
               this.var_1663 = true;
               if(this.var_54 != null && this.var_54.id == const_508)
               {
                  this.showView(const_100);
               }
               break;
            case HabboHelpTutorialEvent.const_592:
               if(this.var_54 != null && this.var_54.id == const_430)
               {
                  this.var_2117 = true;
                  this.disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_583:
               if(this.var_2117)
               {
                  this.var_2117 = false;
                  this.showView(const_100);
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2920 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_356:
               ...
               if(this.var_414 == null)
               {
                  this.var_414 = new NameChangeView(this);
               }
               this.var_414.showMainView();
               this.prepareForTutorial();
               break;
            case const_430:
         ...
         this._window.height = _loc2_.height + this.var_2919;
         this._window.width = _loc2_.width + this.var_2920;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_54 != null && (this.var_54.id == const_356 || this.var_54.id == const_100))
         {
            this.showView(const_100);
         }
      }
      ...
      {
         this.var_1377 = true;
         if(this.var_54 != null && (this.var_54.id == const_430 || this.var_54.id == const_100))
         {
            this.showView(const_100);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_414.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_503)
         {
            this.var_414.checkedName = _loc2_.name;
         }
         else
         {
            this.var_414.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
