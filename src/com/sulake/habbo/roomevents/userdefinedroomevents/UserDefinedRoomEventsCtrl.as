package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_356:int = 3;
      ...
      private var var_2003:TriggerConfs;
      
      private var var_2002:ActionTypes;
      
      private var var_2004:ConditionTypes;
      
      private var var_296:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_861:RoomObjectHightLighter;
      
      private var var_210:UserDefinedRoomEventsHelp;
      
      private var var_1322:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2003 = new TriggerConfs();
         this.var_2002 = new ActionTypes();
         this.var_2004 = new ConditionTypes();
         this.var_296 = new Dictionary();
         super();
         this.var_95 = param1;
         this.var_861 = new RoomObjectHightLighter(param1);
         this.var_210 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_296[param1];
            this.var_861.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_296[param1] = param2;
            this.var_861.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1322 = new SliderWindowController(this.var_95,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_95.assets,0,20,1);
         this.var_1322.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1322.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_861.hideAll(this.var_296);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_37.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_356)
            {
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1322.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_210.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1596) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1596 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_356)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2003);
         this.refreshConfigureElement(this.var_2002);
         this.refreshConfigureElement(this.var_2004);
