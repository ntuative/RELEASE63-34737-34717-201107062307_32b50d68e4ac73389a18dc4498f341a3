package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1893 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1260 = this.var_1893.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1260)
         {
            this.var_1260.procedure = this.onButtonClick;
         }
         this.var_1261 = this.var_1893.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1261)
         {
            this.var_1261.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_283 >= this.var_77.length - 1)
         {
            this.var_1261.disable();
         }
         else
         {
            this.var_1261.enable();
         }
         if(this.var_283 <= 0)
         {
            this.var_1260.disable();
         }
         else
         {
            this.var_1260.enable();
         }
      }
      ...
      {
         ++this.var_283;
         this.var_283 = Math.min(this.var_283,this.var_77.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_283;
         this.var_283 = Math.max(this.var_283,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_77[this.var_283][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_77[this.var_283][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_77[this.var_283][1]).value;
