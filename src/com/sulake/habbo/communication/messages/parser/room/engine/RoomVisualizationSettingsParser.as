package com.sulake.habbo.communication.messages.parser.room.engine
{
   ...
   public class RoomVisualizationSettingsParser implements IMessageParser
   {
      ...
      private var var_1492:Number = 1;
      
      private var var_988:Number = 1;
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         this.var_1804 = param1.readBoolean();
         ...
         this.var_1492 = Math.pow(2,_loc2_);
         this.var_988 = Math.pow(2,_loc3_);
         return true;
      }
   }
}
