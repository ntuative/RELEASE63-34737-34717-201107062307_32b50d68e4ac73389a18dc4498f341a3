package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_746:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_144.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_159,HabboWindowStyle.const_47,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2065,"/");
         if(_loc5_ != null)
         {
         ...
         if(this.var_144.habboConfiguration && this.var_144.habboConfiguration.getKey("try.existing.session","false") == "true")
         {
            this.var_1677 = true;
            this._window.visible = false;
            this.windowEventProcessor(WindowEvent.allocate(WindowEvent.const_167,this._window,null,false));
         }
      }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2065,"/");
         ...
         {
            dispatchEvent(new Event(const_746));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_163.removeEventListener(SSOTicket.const_426,this.onParsedTicketSuccess);
            this.var_163.removeEventListener(SSOTicket.const_380,this.onParsedTicketFailure);
            this.var_163 = null;
         }
         var _loc2_:String = "";
         ...
         var _loc3_:IHabboWebLogin = this.var_144.habboCommunication.habboWebLogin(this.name,this.password);
         this.var_163 = new SSOTicket(this.var_144.assets,_loc3_,_loc2_,param1);
         this.var_163.addEventListener(SSOTicket.const_426,this.onParsedTicketSuccess);
         this.var_163.addEventListener(SSOTicket.const_380,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_163.ticket);
         Logger.log("Has Facebook: " + this.var_163.isFacebookUser);
         if(this.var_163.isFacebookUser)
         {
            this.var_144.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_144.flashClientUrl = this.var_163.flashClientUrl;
         this.var_144.ssoTicket = this.var_163.ticket;
         this.var_163.removeEventListener(SSOTicket.const_426,this.onParsedTicketSuccess);
         this.var_163.removeEventListener(SSOTicket.const_380,this.onParsedTicketFailure);
         this.var_163 = null;
         dispatchEvent(new Event(const_746));
