package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1096:uint = 4284532064;
      
      private static const const_1095:uint = 2577770;
      
      public static const const_1187:int = 0;
      ...
      private var var_670:ItemPopupCtrl;
      ...
      private var var_1036:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_670 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_222)
            {
               this.var_222.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_222.stop();
               this.var_222 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1922 = this.createMinimizedWindow();
         }
         if(!this.var_1155)
         {
            return this.var_79;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_79)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1096) : uint(const_1095);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1096) : uint(const_1095);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_222 = new Timer(1000,3);
            this.var_222.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_222.reset();
         this.var_222.repeatCount = 3;
         this.var_222.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_222.currentCount));
         if(this.var_222.currentCount == 3)
         {
      ...
      public function removeSelection() : void
      {
         if(this.var_1036)
         {
            this.var_1036.isSelected = false;
            this.var_1036 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1997)
            {
            ...
            this.var_670.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_627);
            this.var_670.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_670.hideDelayed();
         }
      }
         ...
         if(this.var_203.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_670.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_627);
               }
            }
            else
            {
