package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1987:uint = 9;
      
      public static const const_219:uint = 0;
      
      public static const const_207:uint = 1;
      
      public static const const_431:uint = 2;
      
      public static const const_331:uint = 3;
      
      public static const const_581:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_60.updateItemList(this.var_815);
         this.var_60.updateItemList(this.var_1526);
      ...
      public function close() : void
      {
         if(this.var_897)
         {
            if(this._state != const_219 && this._state != const_291)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_816 + " OTHER: " + this.var_1248);
         ...
         {
            case const_219:
               if(param1 == const_207 || param1 == const_291)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         if(param1 == this.var_815)
         {
            this.var_281 = param2;
            this.var_1009 = param4;
         }
         else
         {
            this.var_281 = param4;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_60.alertPopup(TradingView.const_1273);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_815)
            {
               this.var_816 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_815)
            {
               this.var_60.alertPopup(TradingView.const_1394);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_281.length < const_1987)
         {
