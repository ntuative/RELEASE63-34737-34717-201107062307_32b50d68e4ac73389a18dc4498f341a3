package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1443:int = 13421772;
      
      private static const const_1444:int = 10275685;
      ...
      protected var var_930:int = 0;
      
      protected var var_745:BitmapData;
      
      protected var var_2586:int;
      ...
      private const const_2066:Number = 1;
      
      private const const_2067:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2303 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2252 == FurniModelCategory.const_37)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1590));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2251);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getOneForTrade() : IItem
      {
         ...
         while(_loc1_ < this._items.length)
         {
            ...
            if(!_loc2_.locked && _loc2_.method_6)
            {
               return _loc2_;
            }
            _loc1_++;
      ...
      public function getTradeableCount() : int
      {
         ...
         {
            _loc3_ = this._items.getWithIndex(_loc2_) as IItem;
            if(_loc3_.method_6 && !_loc3_.locked)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2067;
               _loc1_.blend = this.const_2067;
            }
            else
            {
         ...
         this.var_1487.color = !!this.var_1443 ? uint(const_1444) : uint(const_1443);
         this.var_2303.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2250 && this.getRecyclableCount() > 0)
            {
