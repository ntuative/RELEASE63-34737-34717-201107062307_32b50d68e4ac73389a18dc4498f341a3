package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2356:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_510,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_64.getValue(InventoryCategory.const_77));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_64.getValue(InventorySubCategory.const_345));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_64.getValue(InventoryCategory.const_154));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_64.getValue(InventoryCategory.const_220));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_64.getValue(InventorySubCategory.const_1188));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_64.getValue(InventoryCategory.const_136));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_64.getValue(InventoryCategory.const_455) as MarketplaceModel;
      }
      ...
      {
         this.var_418 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_510,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_85:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_510:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_418 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_64.add(InventoryCategory.const_455,_loc1_);
         ...
         this.var_64.add(InventoryCategory.const_77,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_418);
         this.var_64.add(InventoryCategory.const_220,_loc3_);
         ...
         this.var_64.add(InventoryCategory.const_154,_loc4_);
         ...
         this.var_64.add(InventorySubCategory.const_345,_loc5_);
         ...
         this.var_64.add(InventorySubCategory.const_1188,_loc6_);
         ...
         this.var_64.add(InventoryCategory.const_136,_loc7_);
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2356);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_301));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2642)
         {
            this.var_2642 = _loc1_;
