package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_1643:int = 100;
      
      private static const const_1640:int = 180;
      
      private static const const_1641:int = 200;
      ...
      public function ItemPopupCtrl(param1:IWindowContainer, param2:IAssetLibrary)
      {
         ...
         this.var_400 = new Timer(const_1643,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         if(_loc3_ != null && _loc3_.content != null)
         {
            this.var_855 = _loc3_.content as BitmapData;
         }
      }
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1640,param3.width),Math.min(const_1641,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1983);
         switch(this.var_1983)
         {
            case const_1260:
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         switch(param1)
         {
            case const_1260:
               ...
               _loc2_.y = (this.var_94.height - this.var_1061.height) / 2;
               _loc2_.x = this.var_94.width - 1;
               break;
            case const_627:
               _loc2_.bitmap = this.var_855.clone();
               _loc2_.width = this.var_855.width;
               _loc2_.height = this.var_855.height;
               _loc2_.y = (this.var_94.height - this.var_855.height) / 2;
               _loc2_.x = -1 * this.var_855.width + 1;
         }
         _loc2_.invalidate();
      }
