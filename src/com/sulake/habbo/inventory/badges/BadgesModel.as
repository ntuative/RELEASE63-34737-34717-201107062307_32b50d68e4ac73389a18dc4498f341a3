package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_418 = param5;
         this.var_418.events.addEventListener(BadgeImageReadyEvent.const_204,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_418.events.removeEventListener(BadgeImageReadyEvent.const_204,this.onBadgeImageReady);
            this.var_418 = null;
         }
      }
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1198.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_632.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_418.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_244.unshift(_loc11_);
            }
            else
            {
               this.var_244.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_369);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_244.length)
         {
            _loc3_ = this.var_244[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_630);
         ...
         var _loc3_:Array = this.getBadges(const_369);
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case const_630:
               _loc2_ = new Array();
               for each(_loc3_ in this.var_244)
               {
                  if(!_loc3_.isInUse)
                  {
                     _loc2_.push(_loc3_);
      ...
      {
         return this.getItemInIndex(param1,const_369);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_630);
      }
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_632.indexOf(_loc2_) == -1)
            {
               this.var_632.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_632 && this.var_632.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1373));
            this.var_632 = [];
            for each(_loc2_ in this.var_244)
            {
