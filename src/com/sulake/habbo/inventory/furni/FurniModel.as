package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1668:int = 100;
      
      private static const const_1669:int = 1000;
      ...
      private var var_1609:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_470 = [];
         this.var_469 = [];
         this.var_698 = new Timer(const_1668,1);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_178,this.onObjectPlaced);
               }
            ...
            {
               this.var_229.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_229.stop();
               this.var_229 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_37)
            {
               ...
               {
                  this.var_1609 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1609;
            }
            else
            {
         ...
         if(this.getSelectedItemIndex(const_37) == -1)
         {
            this.toggleItemSelection(const_37,0);
         }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_359)
         {
         ...
         else if(param3 == FurniCategory.const_358)
         {
         ...
         if(this.var_877 == null)
         {
            this.var_877 = this._windowManager.buildFromXML(this.var_2794) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_877.findChildByName("outline") as IBitmapWrapperWindow;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_37,const_45];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_229 = new Timer(param1,1);
            this.var_229.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_229.start();
         }
         else
         {
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_455);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_37,const_45];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_37,const_45];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_697.add(const_37,new Array());
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_284)
            {
      ...
      {
         return getTimer() < this.var_2796 + const_1669;
      }
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_345;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_327 || _loc3_.category == FurniCategory.const_359 || _loc3_.category == FurniCategory.const_358)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               ...
               if(_loc4_.category == FurniCategory.const_766)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function updateView() : void
      {
         if(this._view != null)
         {
            this.updateGroupItems(const_37);
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            ...
            case UnseenItemCategoryEnum.const_453:
               return this.var_469.length;
            default:
               return this.var_470.length + this.var_469.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_45:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_453));
                  this.var_469 = [];
