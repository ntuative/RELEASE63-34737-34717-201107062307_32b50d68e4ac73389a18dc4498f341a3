package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1116:int = 42;
      
      private static const const_1118:int = 120;
      ...
      private var var_830:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_226.add(FurniModelCategory.const_37,new FurniGridView(this.var_78,FurniModelCategory.const_37,this._windowManager,this._assetLibrary,this._roomEngine));
         ...
         this.switchCategory(FurniModelCategory.const_37);
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1103;
            _loc3_.y = _loc4_.y + const_1103;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FurniModelCategory.const_45:
               ...
               break;
            case FurniModelCategory.const_37:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_floor"));
               this.var_466 = FurniModelCategory.const_37;
               break;
            case FurniModelCategory.const_284:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_466 = FurniModelCategory.const_284;
               break;
            default:
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_226.getValue(this.var_466);
         if(_loc3_)
         {
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModelCategory.const_37,FurniModelCategory.const_45];
         var _loc4_:int = 0;
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_217);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_227);
            ...
            if(_loc5_.category == FurniCategory.const_359)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_358)
            {
         ...
         if(_loc11_)
         {
            ...
            {
               if(_loc4_.getUnlockedCount() && _loc5_.method_6)
               {
                  _loc11_.enable();
               }
               else
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_830 && this.var_830.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1364)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1118)
         {
            _loc3_ = const_1118;
         }
         else if(_loc3_ < const_1116)
         {
            _loc3_ = const_1116;
         }
         else
         ...
         else if(param1.type == WindowEvent.const_48)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_284);
            }
         }
      }
