package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_27 != null && this.var_27.furniModel != null && this.var_257 != null)
         {
            this.var_27.furniModel.removeLockFrom(this.var_257.id);
            this.var_257 = null;
         }
      }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_257 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_257.ref));
         this.method_5();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_257 is FloorItem ? 1 : 2;
         this.var_2681 = _loc2_;
         this.var_2674 = this.var_257.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_257.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_257);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_2148,this.var_2149);
         }
      }
      ...
      {
         if(param1 != this.var_2681 || param2 != this.var_2674)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2496);
      }
