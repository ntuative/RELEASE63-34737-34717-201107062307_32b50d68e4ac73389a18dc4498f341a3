package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1120:int = 1;
      
      private const const_1119:int = 2;
      
      private const const_1117:int = 3;
      ...
      private var var_218:IItemGridWindow;
      ...
      private var var_238:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_218 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_238);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_556.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_218.removeGridItem(_loc2_.window);
         if(this.var_238 == _loc2_)
         {
            this.var_238 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_556 == null || this.var_556.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_556.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_556.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_218.addGridItem(_loc2_.window);
            this.var_556.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_238.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_48)
         {
            ...
            {
               case "tab_floor":
                  this.var_78.switchToFurnitureCategory(FurniModelCategory.const_37);
                  break;
               case "tab_wall":
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_238 != null)
         {
            this.var_238.setSelected(false);
         }
         this.var_238 = param1;
         if(this.var_238 != null)
         {
            this.var_238.setSelected(true);
         }
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1120;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1119;
         }
         else
         {
            _loc2_ = this.const_1117;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1120:
               ...
               break;
            case this.const_1119:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1117:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
