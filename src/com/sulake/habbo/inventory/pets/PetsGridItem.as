package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_44:
               this.var_1615.setSelectedGridItem(this);
               this.var_1616 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1616 = false;
                  this.var_1615.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1487.color = !!this.var_1691 ? uint(const_1444) : uint(const_1443);
         this.var_2303.visible = param1;
      }
