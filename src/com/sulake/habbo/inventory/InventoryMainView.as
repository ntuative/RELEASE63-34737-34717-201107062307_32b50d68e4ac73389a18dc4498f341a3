package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2137:IWindowContainer;
      
      private var var_911:String;
      
      private var var_2957:IWindowContainer;
      
      private var var_27:HabboInventory;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1669:IWindowContainer;
      
      private var var_2136:IWindowContainer;
      
      private const const_2101:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_27.inventoryViewOpened(this.var_911);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         else
         {
            ...
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_419 || !this.var_27.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_911);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            ...
            case InventoryCategory.const_136:
               ...
               break;
            case InventoryCategory.const_220:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_2137);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_419 == InventoryCategory.const_136)
            {
               this.toggleCategoryView(InventoryCategory.const_136);
            }
            else if(this.var_419 == InventoryCategory.const_77)
            {
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_2136)
         {
            this.var_2136 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_27.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_2136,_loc1_);
