package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1076:ConversationsTabView;
      
      private var var_962:ITextFieldWindow;
      
      private var var_16:IFrameWindow;
      
      private var var_1605:ConversationView;
      ...
      public function refresh() : void
      {
         ...
         this.var_1076.refresh();
         this.var_1605.refresh();
         if(this.var_157.conversations.openConversations.length < 1)
         {
            this.var_16.visible = false;
         }
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1605.addMessage(param2);
      }
      ...
      private function prepareContent() : void
      {
         ...
         this.var_1076 = new ConversationsTabView(this.var_157,this.var_16);
         this.var_1076.refresh();
         this.var_962 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_962.addEventListener(WindowKeyboardEvent.const_196,this.onMessageInput);
         this.var_1605 = new ConversationView(this.var_157,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_837,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1382,true);
         this.var_16.center();
      }
      ...
      private function sendMsg() : void
      {
         ...
         this.var_962.text = "";
         this.var_157.conversations.addMessageAndUpdateView(new Message(Message.const_856,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_1076 == null ? 7 : int(this.var_1076.getTabCount());
      }
   }
}
