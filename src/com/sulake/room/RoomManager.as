package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1874:int = 0;
      ...
      private var var_179:IRoomManagerListener;
      
      private var var_3116:IRoomContentLoader;
      
      private var var_689:IRoomObjectFactory = null;
      ...
      private var var_2742:Boolean = true;
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_689 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_689 == null || this.var_561 == null)
         {
            return;
         }
         this._state = const_1777;
         if(this.var_1316 != null)
         {
            _loc1_ = this.var_1316;
            this.var_1316 = null;
            this.initialize(_loc1_,this.var_179);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_688.indexOf(_loc5_) < 0)
            {
               this.var_61.loadObjectContent(_loc5_,events);
               this.var_688.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1359;
         return true;
      }
      ...
      {
         return this.var_112.getWithIndex(param1);
      }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_689.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_689 != null)
         {
            return this.var_689.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_61.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_688.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_688.splice(_loc2_,1);
            }
            if(this.var_688.length == 0)
            {
               this._state = const_748;
               if(this.var_179 != null)
               {
                  this.var_179.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_835;
            this.var_179.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_179 != null)
            {
               this.var_179.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_1066.indexOf(_loc2_) < 0)
         {
            this.var_1066.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         {
            _loc2_ = this.var_1066[0];
            this.var_1066.splice(0,1);
            _loc3_ = this.var_61.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_179 != null)
               {
                  this.var_179.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_179 != null)
            {
               this.var_179.contentLoaded(_loc2_,true);
            }
            if(this.var_688.length > 0)
            {
            ...
            _loc5_ = getTimer();
            if(_loc5_ - _loc1_ >= CONTENT_PROCESSING_TIME_LIMIT_MILLISECONDS && this.var_2742)
            {
               this.var_1997 = true;
               break;
            }
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_61 == null || this.var_561 == null)
         {
            return;
         }
         ...
         var _loc8_:int = this.var_112.length - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = this.var_112.getWithIndex(_loc8_) as RoomInstance;
            _loc10_ = this.var_112.getKey(_loc8_);
            if(_loc9_ != null)
            {
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_689.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_179 != null)
                              {
                                 this.var_179.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
