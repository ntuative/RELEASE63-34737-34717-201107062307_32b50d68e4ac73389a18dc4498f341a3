package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1717:int = 50;
      
      private static const const_1160:Number = 60;
      
      private static const const_1716:Number = 50;
      ...
      private var var_308:Sprite;
      
      private var var_164:Sprite;
      ...
      private var var_731:RoomObjectCache;
      
      private var var_590:Array;
      
      private var var_735:Array;
      
      private var var_1679:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2999:Number = -1.0E7;
      
      private var var_2998:Number = -1.0E7;
      ...
      private var var_734:Matrix;
      
      private var var_575:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_308 = new Sprite();
         this.var_308.mouseEnabled = false;
         this.var_117 = new Sprite();
         this.var_117.name = "canvas";
         this.var_117.mouseEnabled = false;
         this.var_308.addChild(this.var_117);
         ...
         this.var_731 = new RoomObjectCache(_loc6_);
         this.var_856 = new ColorTransform();
         this.var_734 = new Matrix();
      ...
      {
         this.var_593.x -= param1 - this.var_732;
         this.var_732 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_593.y -= param1 - this.var_733;
         this.var_733 = param1;
      }
      ...
      {
         if(param1 && !this.var_1040)
         {
            this.var_1040 = true;
            if(this.var_164 != null && !this.var_308.contains(this.var_164))
            {
               this.var_308.addChild(this.var_164);
               this.var_117.mask = this.var_164;
            }
         }
         else if(!param1 && this.var_1040)
         {
            this.var_1040 = false;
            if(this.var_164 != null && this.var_308.contains(this.var_164))
            {
               this.var_308.removeChild(this.var_164);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_308.numChildren > 0)
            {
               this.var_308.removeChildAt(0);
            }
            this.var_308 = null;
         }
         this.var_117 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_735.length)
            {
               this.cleanSprite(this.var_735[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_735 = [];
         }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_164 != null)
         {
            this.var_164.graphics.clear();
         }
         else
         {
            this.var_164 = new Sprite();
            this.var_164.name = "mask";
            if(this.var_1040)
            {
               this.var_308.addChild(this.var_164);
               this.var_117.mask = this.var_164;
         ...
         this.var_164.graphics.beginFill(0);
         this.var_164.graphics.drawRect(0,0,param1,param2);
         this.var_591 = param1;
         this.var_592 = param2;
      }
      ...
      {
         this.var_731.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_2159 = !this.var_2159;
         if(this._container == null || this._geometry == null)
         {
            return;
         }
         if(param1 == this.var_1678)
         {
            return;
         }
         ...
         if(this.var_591 != this.var_2997 || this.var_592 != this.var_3002)
         {
            _loc8_ = true;
         }
         if(this.var_117.x != this.var_732 || this.var_117.y != this.var_733)
         {
            this.var_117.x = this.var_732;
            this.var_117.y = this.var_733;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_590.sortOn("z",0 | 0);
         if(_loc5_ < this.var_590.length)
         {
            this.var_590.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_590[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2997 = this.var_591;
         this.var_3002 = this.var_592;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1678 > 0)
         {
            _loc2_ = param1 - this.var_1678;
            if(_loc2_ > const_1160 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_3000 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_918;
               if(this.var_918 == const_392 + 1)
               {
                  this.var_575 = _loc2_;
                  this.var_2160 = this.var_3001;
               }
               else if(this.var_918 > const_392 + 1)
               {
                  _loc3_ = Number(this.var_918 - const_392);
                  this.var_575 = this.var_575 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2160 = this.var_2160 * (_loc3_ - 1) / _loc3_ + Number(this.var_3001) / _loc3_;
                  if(this.var_918 > const_392 + const_1717)
                  {
                     this.var_918 = const_392;
                     if(!this.var_1394 && this.var_575 > const_1160)
                     {
                        this.var_1394 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1394 && this.var_575 < const_1716)
                     {
                        this.var_1394 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_731.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_731.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2159 && this.var_1394);
         ...
         _loc13_ += int(this.var_591 / 2);
         _loc14_ += int(this.var_592 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_732;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_733;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_590.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_732;
                     _loc17_.y = _loc20_ - this.var_733;
      ...
      {
         if(param1 < this.var_591 && param1 + param3 >= 0 && (param2 < this.var_592 && param2 + param4 >= 0))
         {
            if(!this.var_3096)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_591)
         {
            param3 -= this.var_591 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_592)
         {
            param4 -= this.var_592 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_3003)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1129)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_735.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1129)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_917 || this.var_917 == 0)
         {
            _loc4_ = this.var_1129 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_590[param1] as SortableSprite;
      }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_734.identity();
            if(flipH)
            {
               this.var_734.scale(-1,1);
               this.var_734.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_734.scale(1,-1);
               this.var_734.translate(0,data.height);
            }
            finalData.draw(data,this.var_734);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_856.redMultiplier = tR;
            this.var_856.greenMultiplier = tG;
            this.var_856.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_856);
            if(name.length > 0)
            {
               this.var_309.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_732;
         param2 -= this.var_733;
         this.var_593.x = param1;
         this.var_593.y = param2;
         if(this.var_1393 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
      ...
      {
         var _loc11_:Number = param1 - this.var_591 / 2;
         var _loc12_:Number = param2 - this.var_592 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2158,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_736.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_736.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2999 || param2 != this.var_2998)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_736.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_736.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_423.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1679.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1393 == 0)
         {
            this.checkMouseHits(this.var_593.x,this.var_593.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1393 = 0;
         ++this.var_2158;
      }
