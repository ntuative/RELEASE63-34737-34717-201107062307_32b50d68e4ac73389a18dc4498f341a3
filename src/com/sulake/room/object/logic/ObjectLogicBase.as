package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_394:IRoomObjectController;
      ...
      {
         if(this.var_394 == param1)
         {
            return;
         }
         if(this.var_394 != null)
         {
            this.var_394.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_394 = param1;
            this.var_394.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_394 != null)
            {
               this.var_394.setLocation(param1.loc);
               this.var_394.setDirection(param1.dir);
            }
         }
      }
