package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_546:Number = 64;
      ...
      private var var_3100:Number = -500.0;
      ...
      public function get location() : IVector3d
      {
         ...
         this.var_498.x *= this.var_500;
         this.var_498.y *= this.var_497;
         this.var_498.z *= this.var_501;
         return this.var_498;
      }
      ...
      {
         if(this.var_500 != param1 * this.var_2201)
         {
            this.var_500 = param1 * this.var_2201;
            ++this.var_189;
         }
      }
      ...
      {
         if(this.var_497 != param1 * this.var_2199)
         {
            this.var_497 = param1 * this.var_2199;
            ++this.var_189;
         }
      }
      ...
      {
         if(this.var_501 != param1 * this.var_2200)
         {
            this.var_501 = param1 * this.var_2200;
            ++this.var_189;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_107.x /= this.var_500;
         this.var_107.y /= this.var_497;
         this.var_107.z /= this.var_501;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1406.assign(this.var_173);
         }
         else
         {
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_500;
         _loc2_.y *= this.var_497;
         _loc2_.z *= this.var_501;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1405);
         if(_loc3_ < this.var_3100 || _loc3_ > this.var_3099)
         {
            return null;
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_107.x * this.var_500,this.var_107.y * this.var_497,this.var_107.z * this.var_501);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_173;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_500,param2.y * this.var_497,param2.z * this.var_501);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_500,param3.y * this.var_497,param3.z * this.var_501);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_500,param4.y * this.var_497,param4.z * this.var_501);
      ...
      public function performZoom() : void
      {
         ...
         {
            this.scale = const_546;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_546;
      }
